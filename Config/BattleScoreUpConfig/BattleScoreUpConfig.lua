...
_G.BattleScoreUpConfig = {
	...
	-- 文本
    Text = {
		paixuTips = "<font color='#FFFF00'>点击可切换排序模式</font>";--界面按钮排序tips
		starTips1 ="战斗力+ %s";--星的tips
		starTips2 ="战斗力+ %s(江湖侠客战斗力与人物战斗力无关）";--特殊tips
		strMsg	  = "玩家%s大侠行侠仗义，日";--错误信息
		Advance  ="提升";--提升
		NotOpen  ="未开启";--未开启
		Rule = "<font color='#FFFF00'>点击可查看自身战斗力明细</font>";
