...
function npc_fun.cb_npc_on_opera(objNpc,objPlayer,sysNpc)
	...
	-- local t = {
		-- {dwItemEnum=7100025;dwItemNumber=1;dwBindType=enItemBindType.eYes;}
	-- }
	-- if sysItem:HaveRoomForGroup( enItemPosition.eTaskRoom, t ) then
		
		-- sysItem:AddItem(7100025, enItemPosition.eTaskRoom, 1, enItemBindType.eYes,true , dwLifeTime)
	-- else
	 -- --[[
