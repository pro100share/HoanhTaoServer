...
function npc_fun.cb_npc_on_opera(objNpc,objPlayer,sysNpc,sysScript)
	...
	if sysScript:AddTaskItem(7100158,1,enItemBindType.eYes) 	then 
	else 
		  sysScript:Notice(9000110010)			
	end
	if sysScript:GetItemNum(7100158)<13 then
