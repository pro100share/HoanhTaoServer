...
function npc_fun.shuaguai(objNpc,objPlayer,sysNpc,tbParam,sysScript)
	sysScript.LXX10111093 = sysScript.LXX10111093 or {}
	local sysMap = objPlayer:GetSystem("CMapSystem")
	local sysTask = objPlayer:GetSystem("CTaskSystem")	
	local objMap = sysMap:GetCurMap()
	local mgrMon = objMap:GetMonsterMgr()
	for k,v in pairs(sysScript.LXX10111093) do
	...
	sysScript.LXX10111093[1] = sysScript:AddMonSP(10112007,1090,10112007,10112007,101120090,-75,-43)
	sysScript.LXX10111093[2] = sysScript:AddMonSP(10112007,1090,10112007,10112007,101120090,-74,-47)
end
-----------------------------------------------
