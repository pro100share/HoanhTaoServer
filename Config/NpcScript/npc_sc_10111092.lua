...
function npc_fun.shuaguai(objNpc,objPlayer,sysNpc,tbParam,sysScript)
	...
	local dwObjID = _G.LXXSG10007[dwRoleID]
	if dwObjID then
		...
		_G.LXXSG10007[dwRoleID] = sysScript:AddMonSP(10112016,10112016,10112016,10112016,101120140,-50,-42)
	end		
