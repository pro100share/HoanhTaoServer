...
function npc_fun.shuaguai(objNpc,objPlayer,sysNpc,tbParam,sysScript)
	sysScript.LXX10131088 = sysScript.LXX10131088 or {}
	local sysMap = objPlayer:GetSystem("CMapSystem")
	local sysTask = objPlayer:GetSystem("CTaskSystem")	
	local objMap = sysMap:GetCurMap()
	local mgrMon = objMap:GetMonsterMgr()
	for k,v in pairs(sysScript.LXX10131088) do
	...
	sysScript.LXX10131088[1] = sysScript:AddMonSP(10132013,1111,10132013,10132013,101310040,17,10)
	sysScript.LXX10131088[2] = sysScript:AddMonSP(10132014,1111,10132014,10132014,101310040,17,8)	
end
-----------------------------------------------
