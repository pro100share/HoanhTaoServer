...
_G.DuGuConfig = {
	...
	PracticeList = {
		...
		[1] = {
			...
			nTimesLimit = 100, 		-- 修炼次数限制。 "无限"：无限制，10: 10次限制
			sName 		= "剑魂石", 	-- 修炼所需物品名称："檀香丹"( 可配置 ) or "元宝"
	...
	SwordNeed = {                         --name 
		[1] = { nId = 4100505, nNum = 50  ,name1 = "<font color='#FFFF00' size='16'>【独孤九剑·御剑】</font><font color='#FF0000'>(未激活)</font>",name2 ="<font color='#FFFF00' size='16'>【独孤九剑·御剑 】</font>(已激活)"},
		[2] = { nId = 4100505, nNum = 90  ,name1 = "<font color='#FFFF00' size='16'>【独孤九剑·御气】</font><font color='#FF0000'>(未激活)</font>",name2 ="<font color='#FFFF00' size='16'>【独孤九剑·御气 】</font>(已激活)"},
		[3] = { nId = 4100505, nNum = 170  ,name1 = "<font color='#FFFF00' size='16'>【独孤九剑·御神】</font><font color='#FF0000'>(未激活)</font>",name2 ="<font color='#FFFF00' size='16'>【独孤九剑·御神 】</font>(已激活)"},
		[4] = { nId = 4100505, nNum = 320  ,name1 = "<font color='#FFFF00' size='16'>【独孤九剑·残念】</font><font color='#FF0000'>(未激活)</font>",name2 ="<font color='#FFFF00' size='16'>【独孤九剑·残念 】</font>(已激活)"},
		[5] = { nId = 4100505, nNum = 600  ,name1 = "<font color='#FFFF00' size='16'>【独孤九剑·残式】</font><font color='#FF0000'>(未激活)</font>",name2 ="<font color='#FFFF00' size='16'>【独孤九剑·残式 】</font>(已激活)"},
		[6] = { nId = 4100505, nNum = 1100  ,name1 = "<font color='#FFFF00' size='16'>【独孤九剑·残影】</font><font color='#FF0000'>(未激活)</font>",name2 ="<font color='#FFFF00' size='16'>【独孤九剑·残影 】</font>(已激活)"},
		[7] = { nId = 4100505, nNum = 1800  ,name1 = "<font color='#FFFF00' size='16'>【独孤九剑·无招】</font><font color='#FF0000'>(未激活)</font>",name2 ="<font color='#FFFF00' size='16'>【独孤九剑·无招 】</font>(已激活)"},
		[8] = { nId = 4100505, nNum = 2800  ,name1 = "<font color='#FFFF00' size='16'>【独孤九剑·无形】</font><font color='#FF0000'>(未激活)</font>",name2 ="<font color='#FFFF00' size='16'>【独孤九剑·无形 】</font>(已激活)"},
		[9] = { nId = 4100505, nNum = 3600  ,name1 = "<font color='#FFFF00' size='16'>【独孤九剑·无心】</font><font color='#FF0000'>(未激活)</font>",name2 ="<font color='#FFFF00' size='16'>【独孤九剑·无心 】</font>(已激活)"},
	},

	
	Stage = {  
			   [1] = "<font color='#4daeed'>总诀式</font>";
	           [2] = "<font color='#4daeed'>破剑式</font>";
			   [3] = "<font color='#4daeed'>破刀式</font>";
			   [4] = "<font color='#4daeed'>破枪式</font>";
			   [5] = "<font color='#4daeed'>破鞭式</font>";
			   [6] = "<font color='#4daeed'>破索式</font>";
			   [7] = "<font color='#4daeed'>破掌式</font>";
			   [8] = "<font color='#4daeed'>破箭式</font>";
			   [9] = "<font color='#4daeed'>破气式</font>";
			};	
	Stage2 = {  
			   [1] = "总诀式";
	           [2] = "破剑式";
	...
	ArrtConfig ={
				...
				Shuxing4 = { 																--属性表属性字符串
							dwAttack 	= "<font color='#FFFF00'>攻击</font> + %s ";
							dwDefense 	= "<font color='#FFFF00'>防御</font> + %s";
							dwMPMax     = "<font color='#FFFF00'>内力</font> + %s";
							dwHPMax     = "<font color='#FFFF00'>生命</font> + %s";
							dwFlee 		= "<font color='#FFFF00'>身法</font> + %s";
							dwCrit 		= "<font color='#FFFF00'>暴击</font> + %s";
							dwCritDown  = "<font color='#FFFF00'>暴击抵抗</font> + %s";
							dwPoJiaValue = "<font color='#FFFF00'>破甲攻击</font> + %s";
							dwPoJiaDiKang = "<font color='#FFFF00'>伤害抵御</font> + %s";
			};	
	...
	SwordText = {
				[1] = "【修炼至破刀式】  触发增加自身15%攻击</font>";
				[2] = "【独孤九剑·残影】触发增加自身25%暴击</font>";
				[3] = "【独孤九剑·无招】触发增加自身35%防御</font>";
				[4] = "【独孤九剑·无形】触发增加自身40%破甲攻击</font>";
				[5] = "【独孤九剑·无心】触发恢复自身20%生命</font>";
				};	
    ...
    --Name = "<font color='#FFFF00' size='16'>独孤九剑.%s重 </font><font color='#FF0000'>(未激活)</font>";
    Need1 = "<font color='#FFFFFF'>激活所需 ：满足以下条件后点击按钮即可升级 <br>1. 独孤九剑修炼阶段达%s </font><br><font color='#FFFFFF'>2. 消耗%s：%s/%s把</font> <br><font color='#4daeed'>激活后可获得属性</font>";--白色
	Need2 = "<font color='#FFFFFF'>激活所需 ：满足以下条件后点击按钮即可升级 <br>1. 独孤九剑修炼阶段达%s </font><br><font color='#FFFFFF'>2. 消耗%s：</font><font color='#FF0000'>%s/%s把</font> <br><font color='#4daeed'>激活后可获得属性</font>";--红色
	--YName =  "<font color='#FFFF00' size='16'>独孤九剑.%s重 </font>(已激活)"; 
    sLabel = "<font color='#4daeed'>当前效果</font>";	
	sLabe2 = "<font color='#FFFF00'>【激活独孤九剑技能·%s】</font>";
	--sLabe3 = "（触发技能时额外增加自身20%攻击）";
	sLabe4 = "<font color='#FFFF00'>【激活独孤九剑技能·%s】</font>";
	...
	sLabe5 = "使用%s可快速获取独孤九剑修炼值（每个可提升%s点修炼值）";
	sLabe6 = "使用元宝可快速获取独孤九剑修炼值（每消耗%s元宝可提升%s点修炼值）";

	sLv = "<font color='#4daeed'>Lv.%s</font>";
	stigger = "<font color='#4daeed'>%s %%</font>";
	stime = "可修炼次数 %s";
	sliulianzhi = "<font color='#4daeed'>%s 修炼值</font>";
	smode = "<font color='#4fd388'>剑招修炼</font> <font color='#4daeed'>剑意修炼</font> <font color='#e082da'>剑魂修炼</font>",  --修炼值获取方式
	
	sNotice1 = "该修炼已达今日次数上限，无法修炼";
	sNotice4 = "独孤九剑修炼+ %s";
	

	sNotice5 = "恭喜大侠%s成功修炼独孤九剑·%s";
	sNotice6 = "恭喜大侠%s成功激活独孤九剑·%s，实力大增！";
	
    szName 	= "<font color='#FFFF00'>无剑无我</font>";	--技能名称
	szIcon1	= "img://Icon_sk_wjww_1.png";		--技能图标 彩色
	szIcon2 =  "img://Icon_sk_wjww_0.png";   	--技能图标 灰色
	szActive =	"修炼至破刀式";				--激活条件
	szLearn	= "";			--技能学习状态  --不要
	szType	=	"被动技能";		       --武学类型
    szDes	= "<font color='#4daeed'>修炼至破刀式便可开启”无剑无我“技能，激活独孤九剑·残影、无招、无形、无心可获得额外技能效果</font><font color='#FFFF00'>（技能效果为同时触发，持续10秒）</font>";				--描述
