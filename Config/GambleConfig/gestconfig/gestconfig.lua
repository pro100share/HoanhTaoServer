...
_G.GestDataConfig = {
    ...
    Text={ 	
			Textfig       =T"修复材料不足";   --武尊  修复材料不足
			ZhenqiTextfig =T"所需所有真气不足";  --所需所有真气不足
			NoSuc         =T"领悟未成功";  --领悟未成功
			TipsAttr      = T"已加成属性";--已加成属性
			Tips          = T"达【深不可测】境界后开启";--达【深不可测】境界后开启
			zhenqi        = T"所需每种真气:%s";
			SuccRate      = T"成   功   率:%s";
			IsNoCan1      = T"领悟物品不足"; --领悟物品不足
			IsNoCan2      = T"实战境界不足，实战境界要≥武尊全章境界才能修复。";
			IsEnough		= "<font color='#FFFFFF'>%s</font>";								--物品充足
			IsNoEnough		= "<font color='#FF0000'>%s</font>";	--物品不足
			MaxTips       = T"<p><font size='16' color='#C56925'>至尊属性加成：</p>";
		};
	---------------------------------------------
	--武尊全章等级dwGestLevel
...
{	
	...
	dwFlee=T" 身    法:",
	--dwMoveSpeed = T"移动速度", 
	dwAddSkillLevel = T"无双等级",
	dwMonsterAppend =T" 怪物伤害:", 
	dwBossAppend = T"boss伤害",
	dwAttackSpeed = T" 攻击速度:",
	nFeiBossAppend = T"对非BOSS怪物的伤害",
...
_G.GestDesConfig = {
	...
	["history"] = {
		[1] = T"</p>武尊全章之初篇所载出自街头斗殴技巧，经地痞混混口口相传，简单粗暴，不失实用，但其中多有阴险猥琐的招数，故少为正道之士所用。</p>",
		[2] = T"</p>武尊全章之成篇所载出自山林搏击之术，经绿林好汉总结演化，威猛刚强，大开大阖，不过缺陷明显，不堪大器。</p>",
		[3] = T"</p>武尊全章之会篇所载出自行伍操练之法，经军中将士整理辑录，朴实无华，只取要害，但颇为死板，尚欠变通，难归上乘之属。</p>",
		[4] = T"</p>武尊全章之纯篇所载出自江湖对战套路，经各门各派去芜存菁，于招式套路一道，已无可出其右者。</p>",
		[5] = T"</p>武尊全章之萃篇所载出自无名氏之手，实为其一生功法之精髓，但流传隐秘，唯有机缘匪浅之人，方能得见。</p>",
		[6] = T"</p>武尊全章之雄篇所载据传乃是黄裳作《九阴真经》时，未录之遗稿，虽比《九阴真经》正篇有不及之处，仍是武林中人梦寐以求的典籍，但得一观，此生无憾。</p>",
		[7] = T"</p>武尊全章之深篇乃从少林流出，不知究竟何人所作，若为普通人所得，不过可以强身健体，但若落入得道之人手中，便见字字珠玑，句句切中要害，研而习之，必有脱胎换骨之感。</p>",
		[8] = T"</p>武尊全章之极篇所载出自大内秘藏宝册，登峰造极的修为早已不桎梏于招式，而在于“悟”，此篇正是为你指明“悟”的方向。</p>",
		[9] = T"</p>武尊全章之真篇只存在于江湖传说之中，当今世上无人得窥究竟，然而那些领悟了真篇绝学后得以名垂青史的绝世高人，却无时不在提醒着，真篇……绝不仅仅只是个传说。</p>",
		},
    ["property"] = {
        [1] = GetPropertyText(1);
        [2] = GetPropertyText(2);
	...
	--至尊属性TIPS颜色
	strAttr = {
		dwAttack = T"<font color='#FFFF00'>攻    击:+%d";
		dwDefense=T"<font color='#FFFF00'>防    御:+%d",
		dwHPMax=T"<font color='#FFFF00'>生命上限:+%d",
		dwMPMax=T"<font color='#FFFF00'>内力上限:+%d",
		dwCrit=T"<font color='#FFFF00'>暴    击:+%d",
		dwFlee=T"<font color='#FFFF00'>身    法:+%d",
		dwAddSkillLevel = T"<font color='#FFFF00'>无双等级:+%d",
		dwMonsterAppend =T"<font color='#FFFF00'>怪物伤害:+%d", 
		dwBossAppend = T"<font color='#FFFF00'>boss伤害:+%d",
		dwAttackSpeed = T"<font color='#FFFF00'>攻击速度:+%d",
		nFeiBossAppend = T"<font color='#FFFF00'>对非BOSS怪物的伤害:+%d",
	};
	--属性显示顺序
