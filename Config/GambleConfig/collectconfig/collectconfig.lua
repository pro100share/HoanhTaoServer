...
_G.CollectTextConfig = 
{
	...
	tipPageComplete = T"<font color='#00ff00'>已全部激活</font>";
	tipPageLock = T"<font color='#ff0000'>需%d级解锁</font>";
	tipProgress = T"<font color='#6CE7EE'>当前激活：</font><font color='#dcd9d9'>%d/%d</font><br/><font color='#6BDD65'>风物志分</font><font color='#FDF445'>山河志、古学志、尤物志、神兵志、山海志</font><font color='#6BDD65'>等大类</font><br><font color='#6BDD65'>每一类下由诸多小类组成，激活每一小类均可获得属性加成</font><br><font color='#6BDD65'>激活小类需要提交所需道具，全部提交完整方可成功激活。</font>";
	tipBtn = T"自动将背包中此类道具全部提交";
	tipSeriesComplete = T"<font color='#00ff00'>已激活</font>";
	tipSeriesUnComplete = T"<font color='#ff0000'>未激活：%d/%d</font>";
	tipSeriesDes = T"<font color='#6BDD65'>收集完整后属性加成</font>";
	tipValue = "<font color='#D9671B'>%s + %d</font>";
	
	lblBtn = T"全部提交";
	lblBtnC = T"收集完整";
	
	tipTitle = T"<font color='#6BDD65'>收集完整后属性加成</font>";--标题
	tipStunnerTitle = T"<font color='#6BDD65' size = '16'>当前属性加成</font>";--标题
	...
	tipStunner1 = T"%s<br><font color='#6CE7EE'>收集进度：</font><font color='#dcd9d9'>%d/%d</font><br>%s";
	...
	Noitce = T"恭喜%s完成【风物志】中【%s-%s】收集 %s";
	NoitceCompose = T"恭喜%s完成【风物志】中【%s】收集 %s";
	MeToo = T"我也要收集";
	ShunXu = {"dwHPMax","dwMPMax","dwAttack","dwDefense","dwFlee","dwCrit","dwMoveSpeed","dwAttackSpeed",};

}


local str = T[[此类道具为<u><a href = 'asfunction:hrefevent'><font color = '#6BDD65'>%s</font></a></u>中怪物掉落<br><font color='#cdc6c4'>点击“全部提交”按钮可将背包中道具提交进风物志中，以上道具全部提交完整则获得属性加成</font> ]]
...
_G.CollectConfig = 
{
	...
	{--页签 1
		...
		dwLevel = 31;--解锁等级
		dwSubConfig = 0;--外接配置
		szRollDes = T"<p><font color='#6BDD65'>记载中华各地的美好河山，名胜古迹，人文情怀。</font></p>";
		[1] = 
		{--系列 1
			dwLevel = 31;--解锁等级
			szName = T"<font color='#FDF445'>绝情密涧</font>";--系列名
			dwPic = 1;--图片索引id
			szDes = string.format(str,T[[绝情密涧]]);
			szComTips = T"绝情密涧已全部收集完成<br>已获得相应属性加成";
		...
		{
			dwLevel = 38;
			szName = T"<font color='#FDF445'>大理</font>";
			dwPic = 4;
			szDes = string.format(str,T[[大理]]);
			dwIndex = 1006;
			szComTips = T"大理已全部收集完成<br>已获得相应属性加成";
			Reward = 
			{
				dwHPMax = 525;
				dwMPMax = 38;
		...
		{
			dwLevel = 49;
			szName = T"<font color='#FDF445'>白驼山</font>";
			dwPic = 2;
			szDes = string.format(str,T[[白驼山]]);
			dwIndex = 1007;
			szComTips = T"白驼山已全部收集完成<br>已获得相应属性加成";
			Reward = 
			{
				dwHPMax = 788;
				dwMPMax = 57;
		...
		{
			dwLevel = 59;
			szName = T"<font color='#FDF445'>终南山</font>";
			dwPic = 3;
			szDes = string.format(str,T[[终南山]]);
			dwIndex = 1008;
			szComTips = T"终南山已全部收集完成<br>已获得相应属性加成";
			Reward = 
			{
				dwHPMax = 1173;
				dwMPMax = 84;
		...
		{
			dwLevel = 69;
			szName = T"<font color='#FDF445'>丐帮竹林</font>";
			dwPic = 6;
			szDes = string.format(str,T[[丐帮竹林]]);
			dwIndex = 1009;
			szComTips = T"丐帮竹林已全部收集完成<br>已获得相应属性加成";
			Reward = 
			{
				dwHPMax = 1698;
				dwMPMax = 122;
		...
		{
			dwLevel = 79;
			szName = T"<font color='#FDF445'>华山</font>";
			dwPic = 7;
			szDes = string.format(str,T[[华山]]);
			dwIndex = 1010;
			szComTips = T"华山已全部收集完成<br>已获得相应属性加成";
			Reward = 
			{
				dwHPMax = 2345;
				dwMPMax = 168;
		...
		{
			dwLevel = 89;
			szName = T"<font color='#FDF445'>嵩山少林</font>";
			dwPic = 5;
			szDes = string.format(str,T[[嵩山少林]]);
			dwIndex = 1011;
			szComTips = T"嵩山少林已全部收集完成<br>已获得相应属性加成";
			Reward = 
			{
				dwHPMax = 3168;
				dwMPMax = 227;
		...
		{
			dwLevel = 99;
			szName = T"<font color='#FDF445'>昆仑山</font>";
			dwPic = 8;
			szDes = string.format(str,T[[昆仑山]]);
			dwIndex = 1012;
			szComTips = T"昆仑已全部收集完成<br>已获得相应属性加成";
			Reward = 
			{
				dwHPMax = 7500;
				dwMPMax = 375;
		...
		{
			dwLevel = 109;
			szName = T"<font color='#FDF445'>黑水遗迹</font>";
			dwPic = 9;
			szDes = string.format(str,T[[黑水遗迹]]);
			dwIndex = 1013;
			szComTips = T"黑水遗迹已全部收集完成<br>已获得相应属性加成";
			Reward = 
			{
				dwHPMax = 12500;
				dwMPMax = 625;
	...
	[2] = 
	{
		...
		dwLockPic = 2;
		dwSubConfig = 1;--外接配置
		szRollDes = T"<p><font color='#6BDD65'>记载了古中国的兵法、历史、医学等古学经典名著。</font></p>";
		szRollDesLock = T"<p><font color='#6BDD65'>记载了古中国的兵法、历史、医学等古学经典名著。<br>敬请期待！</font></p>";
		[1] = {	Item = {};};
	};
	[3] = 
	{
		...
		dwShowNum = T"隐藏数字";
		dwSubConfig = 2;--外接配置
		szRollDes = T"<p><font color='#6BDD65'>记载了江湖中十位绝色美女的画像。</font></p>";
		szRollDesLock = T"<p><font color='#6BDD65'>记载了江湖中十位绝色美女的画像。<br>敬请期待！</font></p>";
		[1] = 
		{
			szName = T"<font color='#FDF445'>道家</font>";
			Reward = 
			{
				dwDefense = 0;
			};
	...
	[4] = 
	{
		...
		dwPic = 6;
		dwLockPic = 6;
		szRollDes = T"<p><font color='#6BDD65'>记载了神秘的内容<br>敬请期待！</font></p>";
		szRollDesLock = T"<p><font color='#6BDD65'>记载了神秘的内容<br>敬请期待！</font></p>";
	};
	[5] = 
	{
		szName = T"神秘的内容";--神农志
...
_G.CollectSubConfig = {
	szSubmitBtn = T"合成";
	szListBtn = T"显示列表";
	szListBtnHide = T"隐藏列表";
	szHave = T"已合成";
	szNoHave = T"未合成";
	[1] = {
		szDes = T"说明";
		Notice = T"可以合成古学志物品：<font color = '#00FF00'>[%s]</font>,是否立即合成？";
		Items = {
			[1] = {
				dwItemID = 8101010;
				NeedItem = {
		...
		Values = {
				...
				Reward = 
			{
				...
				szTips = T"<font color = '#FFFFFF'>每激活一本书属性加成</font><br>生命上限 +1000<br>攻    击 +250<br>防    御 +125<br>身    法 +35<br>暴    击 +25<br>";           --根据最终属性修改内容
				szNowTip = T"<font color='#6BDD65'>当前属性加成</font><br>";
			...
			[1] = {
				...
				dwValue = 600;
				szValueText = T"攻击+600";
				szTips = T"激活后属性加成<br>攻击+600<br>合成<font color='#FF6100'>本草纲目、春秋、六韬、孟德新书</font>可激活";
			...
			[2] = {
				...
				szValueType = "dwHPMax";
				dwValue = 3000;
				szValueText = T"生命+3000";
				szTips = T"激活后属性加成<br>生命+3000<br>合成<font color='#FF6100'>春秋、鬼谷子、孟德新书、青囊书</font>可激活";
			...
			[3] = {
				...
				dwValue = 500;
				szValueText = T"攻速+500";
				szTips = T"激活后属性加成<br>攻击速度+500<br>合成<font color='#FF6100'>鬼谷子、黄帝内经、青囊书、三略</font>可激活";
			...
			[4] = {
				...
				dwValue = 300;
				szValueText = T"防御+300";
				szTips = T"激活后属性加成<br>防御+300<br>合成<font color='#FF6100'>六韬、孟德新书、史记、孙子兵法</font>可激活";
			...
			[5] = {
				...
				szValueType = "dwCrit";
				dwValue = 120;
				szValueText = T"暴击+120";
				szTips = T"激活后属性加成<br>暴击+120<br>合成<font color='#FF6100'>孟德新书、青囊书、孙子兵法、吴子兵法</font>可激活";
			...
			[6] = {
				...
				szValueType = "dwFlee";
				dwValue = 150;
				szValueText = T"身法+150";
				szTips = T"激活后属性加成<br>身法+150<br>合成<font color='#FF6100'>青囊书、三略、吴子兵法、左传</font>可激活";
...
[1] = {
		szName=T"襄阳红娘";
		szDes = T"<font color='#6BDD65'>襄阳红娘</font><br>爱侣古城沐红绸，共结连理行江湖。<br><font color='#DCDCDC'>此类道具由初级尤物志礼包开出，世界BOSS、恶人谷BOSS、副本BOSS、珍珑棋局BOSS掉落、风云任务奖励。</font>";
		Tips = T"可以合成古学志物品：<font color = '#00FF00'>[%s]</font>,是否立即合成？";
		dwLockPic = 11;
		szPicBig = "img://collect_xiangyanghongniang_0.jpg";				--szPicBig彩色大图片	
		szComTips = T"襄阳红娘已全部收集完成<br>已获得相应属性加成";   --收集完成按钮 Tips内容
		szRollDes = T"<font color='#6BDD65'>襄阳红娘</font>";
		szRollDesLock = T"<p><font color='#6BDD65'>襄阳红娘<br>爱侣古城沐红绸，共结连理行江湖。</font></p>";
		dwLevel = 31;                                                --级别
...
[2] = {
		szName=T"郊野温香";
		szDes = T"<font color='#6BDD65'>郊野温香</font><br>涛涛战火连荒野，软玉卸妆守襄阳。<br><font color='#DCDCDC'>此类道具由初级尤物志礼包开出，世界BOSS、恶人谷BOSS、副本BOSS、珍珑棋局BOSS掉落、风云任务奖励。</font>";
		Tips = T"可以合成古学志物品：<font color = '#00FF00'>[%s]</font>,是否立即合成？";
		dwLockPic = 12;
		szPicBig = "img://collect_jiaoyewenxiang_0.jpg";				--szPicBig彩色大图片	
		szComTips = T"郊野温香已全部收集完成<br>已获得相应属性加成";
		szRollDes = T"<font color='#6BDD65'>郊野温香</font>";
		szRollDesLock = T"<p><font color='#6BDD65'>郊野温香<br>涛涛战火连荒野，软玉卸妆守襄阳。</font></p>";
		dwLevel = 31;
		Items = {
...
[3] = {
		szName=T"白陀舞姬";
		szDes = T"<font color='#6BDD65'>白陀舞姬</font><br>漫天黄沙卷邪欲，侠行万里斩异妖。<br><font color='#DCDCDC'>此类道具由初级尤物志礼包开出，世界BOSS、恶人谷BOSS、副本BOSS、珍珑棋局BOSS掉落、风云任务奖励。</font>";
		Tips = T"可以合成古学志物品：<font color = '#00FF00'>[%s]</font>,是否立即合成？";
		dwLockPic = 13;
		szPicBig = "img://collect_baituowuji_0.jpg";				--szPicBig彩色大图片，		
		szComTips = T"白陀舞姬已全部收集完成<br>已获得相应属性加成";
		szRollDes = T"<font color='#6BDD65'>白陀舞姬</font>";
		szRollDesLock = T"<p><font color='#6BDD65'>白陀舞姬<br>漫天黄沙卷邪欲，侠行万里斩异妖。</font></p>";
		dwLevel = 31;
		Items = {
...
[4] = {
		szName=T"绝情玉女";
		szDes = T"<font color='#6BDD65'>绝情玉女</font><br>暗黑泉涧无天日，绮梦幽境亦有情。<br><font color='#DCDCDC'>此类道具由初级尤物志礼包开出，世界BOSS、恶人谷BOSS、副本BOSS、珍珑棋局BOSS掉落、风云任务奖励。</font>";
		Tips = T"可以合成古学志物品：<font color = '#00FF00'>[%s]</font>,是否立即合成？";
		dwLockPic = 14;
		szPicBig = "img://collect_jueqingyunv_0.jpg";				--szPicBig彩色大图片，szGrayPicBig灰色大图片		
		szComTips = T"绝情玉女已全部收集完成<br>已获得相应属性加成";
		szRollDes = T"<font color='#6BDD65'>绝情玉女</font>";
		szRollDesLock = T"<p><font color='#6BDD65'>绝情玉女<br>暗黑泉涧无天日，绮梦幽境亦有情。</font></p>";
		dwLevel = 31;
		Items = {
...
[5] = {
		szName=T"西域佳人";
		szDes = T"<font color='#6BDD65'>西域佳人</font><br>葡萄美酒醉风情，灵兽相伴走天涯。<br><font color='#DCDCDC'>此类道具由初级尤物志礼包开出，世界BOSS、恶人谷BOSS、副本BOSS、珍珑棋局BOSS掉落、风云任务奖励。</font>";
		Tips = T"可以合成古学志物品：<font color = '#00FF00'>[%s]</font>,是否立即合成？";
		dwLockPic = 15;
		szPicBig = "img://collect_xiyujiaren_0.jpg";				--szPicBig彩色大图片，szGrayPicBig灰色大图片		
		szComTips = T"西域佳人已全部收集完成<br>已获得相应属性加成";
		szRollDes = T"<font color='#6BDD65'>西域佳人</font>";
		szRollDesLock = T"<p><font color='#6BDD65'>西域佳人<br>葡萄美酒醉风情，灵兽相伴走天涯。</font></p>";
		dwLevel = 31;
		Items = {		
...
[6] = {
		szName=T"江南秀阮";
		szDes = T"<font color='#6BDD65'>江南秀阮</font><br>儿女誓雪世家仇，乱世江湖风云起。";
		Tips = T"可以合成古学志物品：<font color = '#00FF00'>[%s]</font>,是否立即合成？";
		dwLockPic = 16;
		szPicBig = "img://collect_jiangnanxiuruan_0.jpg";				--szPicBig彩色大图片，szGrayPicBig灰色大图片		
		szComTips = T"江南秀阮已全部收集完成<br>已获得相应属性加成";
		szRollDes = T"<font color='#6BDD65'>江南秀阮</font>";
		szRollDesLock = T"<p><font color='#6BDD65'>江南秀阮<br>儿女誓雪世家仇，乱世江湖风云起。</font></p>";
		dwLevel = 150;
		Items = {
...
[7] = {
		szName=T"深谷罗敷";
		szDes = T"<font color='#6BDD65'>深谷罗敷</font><br>寂寞年华锁春心，恶人谷底血成河。";
		Tips = T"可以合成古学志物品：<font color = '#00FF00'>[%s]</font>,是否立即合成？";
		dwLockPic = 17;
		szPicBig = "img://collect_shenguluofu_0.jpg";				--szPicBig彩色大图片，szGrayPicBig灰色大图片		
		szComTips = T"深谷罗敷已全部收集完成<br>已获得相应属性加成";
		szRollDes = T"<font color='#6BDD65'>深谷罗敷</font>";
		szRollDesLock = T"<p><font color='#6BDD65'>深谷罗敷<br>寂寞年华锁春心，恶人谷底血成河。</font></p>";
		dwLevel = 150;
		Items = {
...
[8] = {
		szName=T"南疆巾帼";
		szDes = T"<font color='#6BDD65'>南疆巾帼</font><br>纵使南北千里迢迢，亦将保镖不辱使命。";
		Tips = T"可以合成古学志物品：<font color = '#00FF00'>[%s]</font>,是否立即合成？";
		dwLockPic = 18;
		szPicBig = "img://collect_nanjiangjinguo_0.jpg";				--szPicBig彩色大图片，szGrayPicBig灰色大图片		
		szComTips = T"南疆巾帼已全部收集完成<br>已获得相应属性加成";
		szRollDes = T"<font color='#6BDD65'>南疆巾帼</font>";
		szRollDesLock = T"<p><font color='#6BDD65'>南疆巾帼<br>纵使南北千里迢迢，亦将保镖不辱使命。</font></p>";
		dwLevel = 150;
		Items = {
...
[9] = {
		szName=T"东海青娥";
		szDes = T"<font color='#6BDD65'>东海青娥</font><br>世人皆慕藏宝图，东海远航寻珍奇。";
		Tips = T"可以合成古学志物品：<font color = '#00FF00'>[%s]</font>,是否立即合成？";
		dwLockPic = 19;
		szPicBig = "img://collect_donghaiqinge_0.jpg";				--szPicBig彩色大图片，szGrayPicBig灰色大图片		
		szComTips = T"东海青娥已全部收集完成<br>已获得相应属性加成";
		szRollDes = T"<font color='#6BDD65'>东海青娥</font>";
		szRollDesLock = T"<p><font color='#6BDD65'>东海青娥<br>世人皆慕藏宝图，东海远航寻珍奇。</font></p>";
		dwLevel = 150;
		Items = {
...
[10] = {
		szName=T"南山淑媛";
		szDes = T"<font color='#6BDD65'>南山淑媛</font><br>南山书香气悠然，夫子为国鉴英才。";
		Tips = T"可以合成古学志物品：<font color = '#00FF00'>[%s]</font>,是否立即合成？";
		dwLockPic = 20;
		szPicBig = "img://collect_nanshanshuyuan_0.jpg";				--szPicBig彩色大图片，szGrayPicBig灰色大图片		
		szComTips = T"南山淑媛已全部收集完成<br>已获得相应属性加成";
		szRollDes = T"<font color='#6BDD65'>南山淑媛</font>";
		szRollDesLock = T"<p><font color='#6BDD65'>南山淑媛<br>南山书香气悠然，夫子为国鉴英才。</font></p>";
		dwLevel = 150;
		Items = {
