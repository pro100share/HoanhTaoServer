...
{
	strAttack = T"<p><font color='#DCB857'>攻    击 + %d</font></p>";
	strDefence = T"<p><font color='#DCB857'>防    御 + %d</font></p>";
	strShengMing = T"<p><font color='#DCB857'>生命上限 + %d</font></p>";
	strBaojiDiKang = T"<p><font color='#DCB857'>暴击抵抗 + %d</font></p>";
	...
	strTipTitle = T"<font color = '#87CEEB'>%s</font>  <font color = '#dcdcdc'>进度:%d/%d</font><br>";
	strTipTitle2 = T"<font color='#FF6100' >加成属性</font><br>";
	
	strShowTip = T"使用道具获得成就点数%d";
	
	strNoticeError = T"成就点数不足";
	
	strBtnComplete = T"恭喜玩家%s兑换了<font color='#FF6100'>%s</font>所有的勋章";
