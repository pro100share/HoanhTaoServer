...
_G.GourdConfig={
		...
		[40]={dwAttack=63500,dwDefense=31750,dwFlee=7620,dwCrit=9525,dwHPMax=317500,dwCritDown=9525,dwPoJiaDiKang=6350,Exp =0,},
		-- [41]={dwAttack=45900,dwDefense=22950,dwFlee=5508,dwCrit=6885,dwHPMax=229500,dwCritDown=6885,dwPoJiaDiKang=4590,Exp =7792500,},
		-- [42]={dwAttack=50300,dwDefense=25150,dwFlee=6036,dwCrit=7545,dwHPMax=251500,dwCritDown=7545,dwPoJiaDiKang=5030,Exp =9825500,},
		-- [43]={dwAttack=54700,dwDefense=27350,dwFlee=6564,dwCrit=8205,dwHPMax=273500,dwCritDown=8205,dwPoJiaDiKang=5470,Exp =12083500,},
		-- [44]={dwAttack=59100,dwDefense=29550,dwFlee=7092,dwCrit=8865,dwHPMax=295500,dwCritDown=8865,dwPoJiaDiKang=5910,Exp =14566500,},
		-- [45]={dwAttack=63500,dwDefense=31750,dwFlee=7620,dwCrit=9525,dwHPMax=317500,dwCritDown=9525,dwPoJiaDiKang=6350,Exp =0,},
		};
	--战斗属性
	Shunxu = {"dwAttack";"dwDefense";"dwFlee";"dwCrit";"dwHPMax";"dwCritDown";"dwPoJiaDiKang";}; --属性顺序显示
	ProperyName 	= { 																--界面属性字符串
				dwHPMax 		= T"<font color='#FFFF00'>生命</font> + %d ";
				dwCritDown 		= T"<font color='#FFFF00'>暴击抵抗</font> + %d ";
				...
				dwPoJiaDiKang 	= T"<font color='#FFFF00'>伤害抵御</font> + %d";
			};
		Text = {
				Rule  		= T"<font color='#4daeed'>1.大侠每日可通过提交缨穗、檀木托、烙画图谱、蜂蜡4种道具获得酒葫芦升阶所需的成长值<br/></font><font color='#4daeed'>2.檀木托、烙画图谱、蜂蜡这三种道具每日可提交数量有限</font><font color='#ff0000'>（每日6：00点重置）</font><br/><font color='#4daeed'>3.每日将从檀木托、烙画图谱、蜂蜡3种道具中随机选出一种作为急需品<br/>  当日提交该道具则可获得多倍成长值！</font><font color='#ff0000'>（每日6：00点重置）</font>"; --玩法说明-----------
				StrLadder   = T"<font color='#ffff00'>%d阶</font>";
				StrLevel    = T"<font color='#ffff00'>%d级</font>";
				StrExp  	= T"<font color='#4daeed'>%d成长值</font>";		--熟练度字符串
				ColorExp  	= T"<font color='#ffff00'>%d成长值</font>";		--翻倍熟练度字符串颜色控制
				IsLuck  	= T"<font color='#ff0000' size='15'>今日提交%s可获得%s倍成长值</font>";		--翻倍熟练度字符串颜色控制
				NoLimit  	= T"不限";		--无限制
				IsEnough	= "<font color='#FFFFFF'>%s</font>";	--物品充足
				IsNoEnough	= "<font color='#FF0000'>%s</font>";	--物品不足			
				IsNoCan1	= T"该物品已达今日提交次数上限，无法提交";	--此物品已经达到提交上限
				IsNoCan2	= T"该物品不足，无法提交";	--此物品不足无法执行提交操作
				IsNoCan3	= T"当前没有可以佩戴的酒葫芦";	--目前没有可佩戴的葫芦
				IsNoCan4	= T"无法佩戴当前阶段酒葫芦";	--此模型不可佩戴，请选择可佩带的模型
				IsNoCan5	= T"酒葫芦成长阶段已达满阶，无法提交";	--已经满级无需提交任何物品
				IsNoHaveAut	= T"对方暂未开启酒葫芦，无法查看";	--查看别人没有权限提示
				IsNoOnLine	= T"被查看的玩家没在线";	--查看别人没有在线	恭喜大侠“玩家名称”酒葫芦修炼阶段已达XX阶。
				IsNoHave	= T"78级开启酒葫芦功能";	--BTNTips暂未开启酒葫芦
				IsHaveTips	= T"<font color='#ffffff'>当前酒葫芦阶段：</font><font color='#4daeed'>%s阶</font><br/><font color='#ffffff'>当前酒葫芦等级：</font><font color='#4daeed'>%s级</font><br/><font color='#FFFF00'>【点击酒葫芦按钮打开酒葫芦界面】</font>";	--BTNTips已开启
				broadcast	= T"恭喜大侠%s将酒葫芦提升至%s";     --广播
				IWantStr    = T"我也试试！";		--广播我也试试
				TipsBtn1    = T"佩戴%s"; --佩戴什么葫芦
				TipsBtn2    = T"摘下%s"; --摘下什么葫芦
				TipsBtn3    = T"成长阶段达五阶可佩戴酒葫芦"; -- 目前没有可佩戴的葫芦是的 提示
				ExpUp       = T"成长值+ %d"
		};
	GourdString =
				{
	...
	-- [9] = {
		-- model = {
			-- sknFile = "A_Equip_JiuHuLu_01.skn"; sklFile="A_Equip_JiuHuLu.skl"; sanFile ="A_Equip_BaoJian_DaiJi.san"; param_1_x = -0.169; param_1_y =-9.339; param_1_z = 2.874;param_2_x = 0; param_2_y = 0; param_2_z = 0; lieAction = "A_NPC_Equip_BaoJian_XiuXian.san";
		-- },
...
function GourdConfig:GetGourdItemInfo()
	...
	[2] = {ItemID = 4100446;Limit = 10;AddExp = 200};	
	[3] = {ItemID = 4100447;Limit = 10;AddExp = 300};
	[4] = {ItemID = 4100448;Limit = 10;AddExp = 600};
	} 
	return Info
end
--获取当前等级属性
