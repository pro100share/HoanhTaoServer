...
{
	Title = T"【装备修炼·百炼神兵】<br/>";
	Condition = T[[<p align="left"><font  face='黑体,宋体' size='14' color="%s">%s</font></p>]];--激活条件
}
...
_G.EquipBuildSuitTipsCondition = 
{
	[1]=
	{
		szName = T"<img src = 'img://Xtb_weapon.png'>装备修炼(1级)",
		szCondition = T"激活条件:(%d/12)件装备修炼达到%d级,点击使用%sX%d个【未激活】",
		szEffort = T"加成效果：",
	};
	[2]=
	{
		szName = T"<img src = 'img://Xtb_weapon.png'>装备修炼(%d级)",
		szCondition = T"激活条件:(%d/12)件装备修炼达到%d级,点击使用%sX%d个【已激活】",
		szEffort = T"加成效果：",
	};
	[3]=
	{
...
_G.SuitLevelCondition = 
{
	[1] = 
	{
		...
		szName = T"<img src = 'img://Xtb_weapon.png'>龙骧神甲(1级)";			--套装名
		szCondition = T"激活条件：全身12件装备均强化+7以上";		--条件
		szEffort = T"加成效果：<img src = 'img://zb_xfk_shuxing_biaoshi.png'>攻击 + 120<br/>          <img src = 'img://zb_xfk_shuxing_biaoshi.png'>防御 + 60<br/>          <img src = 'img://zb_xfk_shuxing_biaoshi.png'>生命 + 384<br/>          <img src = 'img://zb_xfk_shuxing_biaoshi.png'>内力 + 36";			--效果
	};
	[2] = 
	{
		dwPosNumber = 12;		--满足的装备位数量
		szName = T"<br/><img src = 'img://Xtb_weapon.png'>龙骧神甲(2级)";			--套装名
		szCondition = T"激活条件：全身12件装备均强化+10以上";		--条件
		szEffort = T"加成效果：<img src = 'img://zb_xfk_shuxing_biaoshi.png'>攻击 + 275<br/>          <img src = 'img://zb_xfk_shuxing_biaoshi.png'>防御 + 138<br/>          <img src = 'img://zb_xfk_shuxing_biaoshi.png'>生命 + 880<br/>          <img src = 'img://zb_xfk_shuxing_biaoshi.png'>内力 + 83<br/>          <img src = 'img://zb_xfk_shuxing_biaoshi.png'>身法 + 55";			--效果
	};
	[3] = 
	{
		dwPosNumber = 12;	--满足的装备位数量
		szName = T"<br/><img src = 'img://Xtb_weapon.png'>龙骧神甲(3级)";			--套装名
		szCondition = T"激活条件：全身12件装备均强化+15";		--条件
		szEffort = T"加成效果：<img src = 'img://zb_xfk_shuxing_biaoshi.png'>攻击 + 600<br/>          <img src = 'img://zb_xfk_shuxing_biaoshi.png'>防御 + 300<br/>          <img src = 'img://zb_xfk_shuxing_biaoshi.png'>生命 + 2100<br/>          <img src = 'img://zb_xfk_shuxing_biaoshi.png'>内力 + 180<br/>          <img src = 'img://zb_xfk_shuxing_biaoshi.png'>身法 + 120<br/>          <img src = 'img://zb_xfk_shuxing_biaoshi.png'>攻击 + 5%<br/>          <img src = 'img://zb_xfk_shuxing_biaoshi.png'>防御 + 5%";		--效果
	};
}
...
{
	Title = T"【强化套装·龙骧神甲】<br/>";
	Activation = {
		[0] = T"【已激活】";
		[1] = T"【未激活%d/%d】";
		[2] = T"【极致套装】";
	};
	Prompt = T"<font color='#cdc6c4'><br/>温馨提示：<br/>可以通过装备炼制系统对您的装备进行强化<br/>装备强化→获得满强化装备</p></font>";
	Color = {--颜色
	...
	Format = {--格式化配置
		Title = T[[<p align="center"><font face='黑体,宋体' size='18' color='#FDF445'>%s</font></p>]];--标题
		Name = T[[<p align="left"><font  face='黑体,宋体' size='16' color="%s">%s</font></p>]];--套装名
		Condition = T[[<p align="left"><font  face='黑体,宋体' size='14' color="%s">%s	%s</font></p>]];--激活条件
		Effort = T[[<p align="left"><font  face='黑体,宋体' size='14' color="%s">%s</font></p>]];--激活效果
		Prompt = T[[<p align="left"><font  face='黑体,宋体' size='14'>%s</font></p>]];--温馨提示
		Activation = T[[<font face='黑体,宋体' size='14' color="%s">%s</font>]];--激活状态（已激活，未激活）
	};
}
...
_G.SuitQualityCondition = 
{
	[1] = 
	{
		...
		szName = T"<img src = 'img://Xtb_weapon.png'>绝世奇珍(1级)";			--套装名
		szCondition = T"激活条件：全身4件紫色装备";		--条件
		szEffort = T"加成效果：<img src = 'img://zb_xfk_shuxing_biaoshi.png'>攻击 + 80<br/>          <img src = 'img://zb_xfk_shuxing_biaoshi.png'>防御 + 40<br/>          <img src = 'img://zb_xfk_shuxing_biaoshi.png'>生命 + 256<br/>          <img src = 'img://zb_xfk_shuxing_biaoshi.png'>内力 + 24";			--效果
	};
	[2] = 
	{
		dwPosNumber = 8;		--满足的装备位数量
		szName = T"<br/><img src = 'img://Xtb_weapon.png'>绝世奇珍(2级)";			--套装名
		szCondition = T"激活条件：全身8件紫色装备";		--条件
		szEffort = T"加成效果：<img src = 'img://zb_xfk_shuxing_biaoshi.png'>攻击 + 180<br/>          <img src = 'img://zb_xfk_shuxing_biaoshi.png'>防御 + 90<br/>          <img src = 'img://zb_xfk_shuxing_biaoshi.png'>生命 + 576<br/>          <img src = 'img://zb_xfk_shuxing_biaoshi.png'>内力 + 54<br/>          <img src = 'img://zb_xfk_shuxing_biaoshi.png'>身法 + 36";			--效果
	};
	[3] = 
	{
		dwPosNumber = 12;	--满足的装备位数量
		szName = T"<br/><img src = 'img://Xtb_weapon.png'>绝世奇珍(3级)";			--套装名
		szCondition = T"激活条件：全身12件紫色装备";		--条件
		szEffort = T"加成效果：<img src = 'img://zb_xfk_shuxing_biaoshi.png'>攻击 + 380<br/>          <img src = 'img://zb_xfk_shuxing_biaoshi.png'>防御 + 190<br/>          <img src = 'img://zb_xfk_shuxing_biaoshi.png'>生命 + 1216<br/>          <img src = 'img://zb_xfk_shuxing_biaoshi.png'>内力 + 114<br/>          <img src = 'img://zb_xfk_shuxing_biaoshi.png'>身法 + 76<br/>          <img src = 'img://zb_xfk_shuxing_biaoshi.png'>闪避率 + 5%<br/>          <img src = 'img://zb_xfk_shuxing_biaoshi.png'>暴击率 + 5%";		--效果
	};
}
...
{
	Title = T"【高品质套装·绝世奇珍】<br/>";
	Activation = {
		[0] = T"【已激活】";
		[1] = T"【未激活%d/%d】";
		[2] = T"【极致套装】";
	};
	Prompt = T"<font color='#cdc6c4'><br/>温馨提示：<br/>您可以通过击杀BOSS，副本等途径获得高品质装备</font>";--<font color='#cdc6c4'><br/>温馨提示：<br/>可以通过装备炼制系统对您的装备进行洗炼<br/>洗炼品质→获得高品质装备</font>
	Color = {--颜色
		Name = "#dd02dc";--套装名字（1级xxx套装）
		Activation = {--激活状态
			[0] = "#4ae833";--已激活
...
_G.SuitStoneCondition = 
{
	...
	{
		dwPosNumber = 12;		--满足的装备位数量
		szName = T"<img src = 'img://Xtb_weapon.png'>辉曜宝器(1级)";			--套装名
		szCondition = T"12件人物装备满镶嵌3品宝石";		--条件
		szEffort = T"加成效果：<img src = 'img://zb_xfk_shuxing_biaoshi.png'>攻击 + 100<br/>          <img src = 'img://zb_xfk_shuxing_biaoshi.png'>防御 + 50<br/>          <img src = 'img://zb_xfk_shuxing_biaoshi.png'>生命 + 320<br/>          <img src = 'img://zb_xfk_shuxing_biaoshi.png'>内力 + 30";			--效果
	};
	[2] = 
	{
		dwPosNumber = 12;		--满足的装备位数量
		szName = T"<br/><img src = 'img://Xtb_weapon.png'>辉曜宝器(2级)";			--套装名
		szCondition = T"12件人物装备满镶嵌5品宝石";		--条件
		szEffort = T"加成效果：<img src = 'img://zb_xfk_shuxing_biaoshi.png'>攻击 + 200<br/>          <img src = 'img://zb_xfk_shuxing_biaoshi.png'>防御 + 100<br/>          <img src = 'img://zb_xfk_shuxing_biaoshi.png'>生命 + 640<br/>          <img src = 'img://zb_xfk_shuxing_biaoshi.png'>内力 + 60<br/>          <img src = 'img://zb_xfk_shuxing_biaoshi.png'>身法 + 40";			--效果
	};
	[3] = 
	{
		dwPosNumber = 12;	--满足的装备位数量
		szName = T"<br/><img src = 'img://Xtb_weapon.png'>辉曜宝器(3级)";			--套装名
		szCondition = T"12件人物装备满镶嵌7品宝石";		--条件
		szEffort = T"加成效果：<img src = 'img://zb_xfk_shuxing_biaoshi.png'>攻击 + 420<br/>          <img src = 'img://zb_xfk_shuxing_biaoshi.png'>防御 + 210<br/>          <img src = 'img://zb_xfk_shuxing_biaoshi.png'>生命 + 1344<br/>          <img src = 'img://zb_xfk_shuxing_biaoshi.png'>内力 + 126<br/>          <img src = 'img://zb_xfk_shuxing_biaoshi.png'>身法 + 84<br/>          <img src = 'img://zb_xfk_shuxing_biaoshi.png'>命中率 + 5%<br/>          <img src = 'img://zb_xfk_shuxing_biaoshi.png'>生命 + 5%";		--效果
	};
	[4] = 
	{
		dwPosNumber = 12;	--满足的装备位数量
		szName = T"<br/><img src = 'img://Xtb_weapon.png'>辉曜宝器(4级)";			--套装名
		szCondition = T"12件人物装备满镶嵌9品宝石";		--条件
		szEffort = T"加成效果：<img src = 'img://zb_xfk_shuxing_biaoshi.png'>攻击 + 1200<br/>          <img src = 'img://zb_xfk_shuxing_biaoshi.png'>防御 + 600<br/>          <img src = 'img://zb_xfk_shuxing_biaoshi.png'>生命 + 5000<br/>          <img src = 'img://zb_xfk_shuxing_biaoshi.png'>内力 + 300<br/>          <img src = 'img://zb_xfk_shuxing_biaoshi.png'>身法 + 500<br/>          <img src = 'img://zb_xfk_shuxing_biaoshi.png'>命中率 + 8%<br/>          <img src = 'img://zb_xfk_shuxing_biaoshi.png'>生命 + 8%<br/>          <img src = 'img://zb_xfk_shuxing_biaoshi.png'>暴击抵抗 + 1000<br/>          <img src = 'img://zb_xfk_shuxing_biaoshi.png'>伤害减免 + 1500";		--效果 
	};
	-- [5] = 
	-- {
		-- dwPosNumber = 12;	--满足的装备位数量
		-- szName = T"<br/><img src = 'img://Xtb_weapon.png'>辉曜宝器(5级)";			--套装名
		-- szCondition = T"12件人物装备满镶嵌12品宝石";		--条件
		-- szEffort = T"加成效果：<img src = 'img://zb_xfk_shuxing_biaoshi.png'>攻击 + 2300<br/>          <img src = 'img://zb_xfk_shuxing_biaoshi.png'>防御 + 1100<br/>          <img src = 'img://zb_xfk_shuxing_biaoshi.png'>生命 + 11000<br/>          <img src = 'img://zb_xfk_shuxing_biaoshi.png'>内力 + 500<br/>          <img src = 'img://zb_xfk_shuxing_biaoshi.png'>身法 + 1200<br/>          <img src = 'img://zb_xfk_shuxing_biaoshi.png'>命中率 + 10%<br/>          <img src = 'img://zb_xfk_shuxing_biaoshi.png'>生命 + 10%<br/>          <img src = 'img://zb_xfk_shuxing_biaoshi.png'>暴击抵抗 + 1700<br/>          <img src = 'img://zb_xfk_shuxing_biaoshi.png'>伤害减免 + 2100";		--效果 
	-- };
}
--宝石套装用到的额外文本信息
_G.SuitStoneExtraText = {
	Title = T"【宝石套装·辉曜宝器】<br/>";
	Activation = {
		[0] = T"【已激活】";
		[1] = T"【未激活%d/%d】";
		[2] = T"【极致套装】";
	};
	Prompt = T"<br/><font color='#cdc6c4'>温馨提示：<br/>合成后的宝石可免费镶嵌到装备中或者从装备中取出<br/>镶嵌宝石品级越高，加成属性越高<font/>";
	Color = {--颜色
		Name = "#dd02dc";--套装名字（1级xxx套装）
		Activation = {--激活状态
			[0] = "#4ae833";--已激活
...
_G.SuitWeaponCondition = 
{
	[1] = 
	{
		...
		szName = T"<img src = 'img://Xtb_weapon.png'>乾戎天兵(1级)";			--套装名
		szCondition = T"激活条件：装备武器强化+7以上";		--条件
		szEffort = T"加成效果：微星开刃，流光森然";			--效果
	};
	[2] = 
	{
		dwPosNumber = 1;		--满足的装备位数量
		szName = T"<br/><img src = 'img://Xtb_weapon.png'>乾戎天兵(2级)";			--套装名
		szCondition = T"激活条件：装备武器强化+10以上";		--条件
		szEffort = T"加成效果：引雷拂电，壮气惊云";			--效果
	};
	[3] = 
	{
		dwPosNumber = 1;	--满足的装备位数量
		szName = T"<br/><img src = 'img://Xtb_weapon.png'>乾戎天兵(3级)";			--套装名
		szCondition = T"激活条件：装备武器强化+15";		--条件
		szEffort = T"加成效果：灼辉凌日，百神临观";		--效果
	};
}
--武器套装用到的额外文本信息
_G.SuitWeaponExtraText = {
	Title = T"【武器强化·乾戎天兵】<br/>";
	Activation = {
		[0] = T"【已激活】";
		[1] = T"【未激活%d/%d】";
		[2] = T"【极致套装】";
	};
	Prompt = T"<font color='#cdc6c4'><br/>温馨提示：<br/>可以通过装备炼制系统对您的武器进行强化<br/>装备强化→获得满强化武器</p></font>";
	Color = {--颜色
		Name = "#dd02dc";--套装名字（1级xxx套装）
		Activation = {--激活状态
			[0] = "#4ae833";--已激活
