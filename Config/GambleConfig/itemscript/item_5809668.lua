...
function ItemScriptObj:OnUseItem(objItemSys, objItem)
	...
	local cachievementSystem = objPlayer:GetSystem('CAchievementSystem')
	if not cachievementSystem then 
		return 0
	end	
	 
	cachievementSystem:AddPlusPoint(100)
...
function ItemScriptObj:OnUseMassItem(objItemSys, objItem, sysScript,num)
	...
	cachievementSystem:AddPlusPoint(100*num)
