local dwItemId = 6300561    --排行榜钻石礼包
local ItemScriptObj = {};
setmetatable(ItemScriptObj, {__index = CItemScript});
--物品ID,1概率  2数量
local data = {
		{9405011,5,5};     ---龙池甘露*5
		{4100442,1500,5};     ---九转熊蛇丸*5
		{4100440,1700,5};     ---虎骨壮筋散*5
...
function ItemScriptObj:OnUseItem(objItemSys, objItem)
	...
	Scriptsys:AddPackItem(2400140,1,enItemBindType.eYes)
	Scriptsys:AddPackItem(5940006,5,enItemBindType.eYes)
	Scriptsys:AddPackItem(5910005,3,enItemBindType.eYes)	
