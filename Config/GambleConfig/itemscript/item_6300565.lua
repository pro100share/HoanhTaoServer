local dwItemId = 6300565    --排行榜青铜礼包
local ItemScriptObj = {};
...
function ItemScriptObj:OnUseItem(objItemSys, objItem)
	...
	Scriptsys:AddPackItem(2400110,1,enItemBindType.eYes)
	Scriptsys:AddPackItem(5940003,5,enItemBindType.eYes)
	Scriptsys:AddPackItem(5910003,5,enItemBindType.eYes)	
