local dwItemId = 6300562    --排行榜白金礼包
local ItemScriptObj = {};
...
function ItemScriptObj:OnUseItem(objItemSys, objItem)
	...
	Scriptsys:AddPackItem(2400130,1,enItemBindType.eYes)
	Scriptsys:AddPackItem(5940005,5,enItemBindType.eYes)
	Scriptsys:AddPackItem(5910005,2,enItemBindType.eYes)	
