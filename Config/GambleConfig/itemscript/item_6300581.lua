local dwItemId = 6300581    --华山论剑十强礼包
local ItemScriptObj = {};
setmetatable(ItemScriptObj, {__index = CItemScript});
--物品ID,1概率  2数量
local data = {
		{4100502,500,1};     ---天女散花*1
		{4100010,500,1};     ---千纸鹤*1
		{5940006,1000,1};     ---真气丹(1W)*1
		{4100453,500,1};     ---淬炎晶*1
...
function ItemScriptObj:OnUseItem(objItemSys, objItem)
	...
	if objItemSys:AddEnumItemListToPacket(addTable, _G.ItemSysOperType.Used, true) then
		if (id == 5501190 or id == 4100507 ) then
