...
function ItemScriptObj:OnUseItem(objItemSys, objItem)
	...
	local CurBuffValue = buffsys:GetBuffCurValue(2500080)
	if (CurBuffValue+5000000) >= _G.InitConfig.dwBuffValue then
		return 3003010006;
	end
	    objPlayer:GetSystem('CBuffSystem'):AddBuff(2500080,6);
	return false;
end
...
function ItemScriptObj:OnUseMassItem(objItemSys, objItem, sysScript,num)
	local objPlayer = objItemSys:GetPlayer();
	objPlayer:GetSystem('CBuffSystem'):MassAddBuff(2500080,6,nil,nil,num);
end
