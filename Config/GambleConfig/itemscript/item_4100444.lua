...
function ItemScriptObj:OnUseItem(objItemSys, objItem)
	...
	local Chack = cpractiseSkillSystem:UseItemAddMendValue(50000)
	if not Chack then
		return false;
	else
		return 13009400204
...
function ItemScriptObj:OnUseMassItem(objItemSys, objItem, sysScript,num)
	...
	cpractiseSkillSystem:UseItemAddMendValue(50000*num)
	return false
end
