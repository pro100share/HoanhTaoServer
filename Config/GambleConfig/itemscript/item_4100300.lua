...
function ItemScriptObj:OnUseItem(objItemSys, objItem, sysScript)
	objItemSys:GetPlayer():GetSystem("CSwordSystem"):UpdateSwordProperty(100)
end
...
function ItemScriptObj:OnUseMassItem(objItemSys, objItem, sysScript,num)
	print( "num====================================",num )
	objItemSys:GetPlayer():GetSystem("CSwordSystem"):UpdateSwordProperty(100*num)
end
-------------------------------------------------------
