...
BournHideAttrConfig.PropertyText = {
	...
	dwCrit          = {4,T"暴    击"},
	dwFlee          = {5,T"身    法"},
	dwRemitAttack   = {6,T"伤害减免"},
	dwAllSkillUpLv  = {7,T"武功层数"},
};
...
--领取不成功提示
BournHideAttrConfig.szNotGet = T"不满足激活条件！";

-- 广播消息
BournHideAttrConfig.szBroadcastTex = T"恭喜<font color='#22a6fa'>%s</font>大侠凭借超凡悟性，参透无字天书，领悟实战境界之精深奥义，激活隐藏属性，获得大幅属性提升！从此睥睨天下，何人能敌！";
