...
_G.CollectJewelConfig = {
	...
	SetMaiInfo = function(AwardInfo,nType)
		...
		if(nType == 1) then
			mailMsg.topic = T"聚灵珠注灵奖励";
		elseif(nType == 2) then
			mailMsg.topic = T"聚灵珠收获奖励";
		end
...
_G.CollectJewelTipsConfig = {
	...
	GainsExplain = T[[<font color="#FFFFFF">聚灵进度达到</font><font color="#de00ff">100%</font><font color="#FFFFFF">可获得下列奖励</font>]]; --收获奖励说明
	FillExplain = T[[<font color="#dc911a">每日自动增长10%进度，注灵可加速聚灵进度，并可获得下列奖励</font>]];	--注灵奖励说明
	CollectPro = [[<font color="#00FF00">%s</font>]];	--聚灵进度
	szBroadCastMsg = T[[<font %s>%s</font><font >聚灵</font><font color="#00FFFF">%s</font><font >获得超值大奖</font><font color='%s'>%s</font>,<font color='%s'>,%s</font><font color='%s'>,%s</font><font color='%s'>,%s</font><font color='%s'>,%s</font>]]; --广播消息 --(T"%s聚灵%s获得超值大奖%s,%s,%s,%s,%s")
	szCostGold = T"<font color='#dc911a'>是否花费%d元宝开启%s聚灵</font>",
	szNotEnoughtGold = T"元宝不足",
	szStarGrains = T"<p><font color='#dc911a'>花费%d元宝开启%s聚灵</font></p><p><font color='#FFFFFF'>每日可自动增加</font><font color='#de00ff'>%s</font><font color='#FFFFFF'>进度</font></p>", -->未聚灵
	szGainsing = T"<p><font color='#dc911a'>目前进度：</font>%s</p><p><font color='#dc911a'>今日已注灵：</font>%d</p><p><font color='#de00ff'><font color='#ffffff'>剩余</font><font color='#de00ff'>%s</font><font color='#ffffff'>进度可收获丰厚奖励</font></p>", -->正聚灵
	szGrainsed = T"<font color='#dc911a'>点击收获按钮可收获奖励</font>", -->聚灵完成
	szFill = T"<p><font color='#dc911a'>消耗%d元宝注灵%s</font></p><p>增加进度</font><font color='#de00ff'>%s%%</font>进度</p>",
	szNotFillCost = T"<font color='#ff0000'>此灵珠今日注灵次数已达上限</font>",
	szNotCollect = T"<font color='#ff0000'>请先点击灵珠开启聚灵，才可注灵</font>",
	szFillFull = T"聚灵完成，请点击收获按钮收获奖励",
	szFillBt = T"<p><font color='#dc911a'>花费%d元宝注灵%s加速聚灵进度</font></p><p><font color='#dc911a'>此灵珠今日剩余注灵次数：</font>%d</p>",
	szNotCanGains = T"<font color='#dc911a'>聚灵进度达到100%才可收获奖励</font>",
	szGainsItem = T"灵珠奖励已发放，物品自动放入背包内",
	szEmailSuc = T"灵珠奖励已发放，物品奖励请查收邮件",
	szEmailFail = T"您的物品栏及邮件已满，请及时清理",
	szNotCount = T"<font color='#ff0000'>今日注灵次数已达上限</font>",
	szExplain = T"<font color='#ff0000'>每日已开启聚灵的灵珠会自动增加10%进度，进度达到100%点击收获领取奖励</font>",
};
