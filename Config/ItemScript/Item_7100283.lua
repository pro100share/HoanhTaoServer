...
local dwNowTime = _now()
	...
	if dwMapId ~= 5108 then sysTask:Error(999911) return nil end;
	if math.sqrt((fPosX-1)^2+(fPosY-6)^2) > 5 then sysTask:Error(999911) return nil end; 
