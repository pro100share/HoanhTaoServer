...
local dwNowTime = _now()
	...
	if dwMapId ~= 5099 then sysTask:Error(999911) return nil end;
	if math.sqrt((fPosX+5)^2+(fPosY-23)^2) > 5 then sysTask:Error(999911) return nil end; 
