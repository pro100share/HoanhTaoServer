...
local dwNowTime = _now()
	...
	if dwMapId ~= 8025 then sysTask:Error(999911) return nil end;
	if math.sqrt((fPosX+8)^2+(fPosY+2)^2) > 5 then sysTask:Error(999911) return nil end; 
