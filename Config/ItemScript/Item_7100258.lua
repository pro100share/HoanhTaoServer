...
local dwNowTime = _now()
	...
	if dwMapId ~= 1010 then sysTask:Error(999911) return nil end;
	if math.sqrt((Pos.x-40)^2+(Pos.y+110)^2) > 5 then sysTask:Error(999911) return nil end; 
