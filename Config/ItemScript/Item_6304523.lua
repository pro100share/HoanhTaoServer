local dwItemId = 6304523    --特级银两礼包
local ItemScriptObj = {};
setmetatable(ItemScriptObj, {__index = CItemScript});
--物品ID,1概率  2数量
local data = {
		{5920001,625,1};     ---钱袋(5万)*1
		{5920002,1800,1};     ---钱袋(10万)*1
		{5920001,3600,5};     ---钱袋(5万)*5
		{5920003,3600,1};     ---钱袋(50万)*1
		{5920004,200,1};     ---钱袋(100万)*1
		{5920003,100,5};     ---钱袋(50万)*5
		{5920005,50,1};     ---钱袋(500万)*1
		{5920006,25,1};     ---钱袋(1000万)*1
};
...
function ItemScriptObj:OnUseItem(objItemSys, objItem)
	...
	if objItemSys:AddEnumItemListToPacket(addTable, _G.ItemSysOperType.Used,true) then
		if (id==5920006 and count==1) then
