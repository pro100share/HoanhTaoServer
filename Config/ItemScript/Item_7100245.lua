...
local dwNowTime = _now()
	...
	if dwMapId ~= 5098 then sysTask:Error(999911) return nil end;
	-- if math.sqrt((fPosX+28)^2+(fPosY+34)^2) > 5 then sysTask:Error(999911) return nil end; 
