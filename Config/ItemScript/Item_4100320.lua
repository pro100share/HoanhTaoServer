...
function ItemScriptObj:OnUseItem(objItemSys, objItem, sysScript)
	objItemSys:GetPlayer():GetSystem("CSwordSystem"):UpdateSwordProperty(1000)
end
...
function ItemScriptObj:OnUseMassItem(objItemSys, objItem, sysScript,num)
	print( "num====================================",num )
	objItemSys:GetPlayer():GetSystem("CSwordSystem"):UpdateSwordProperty(1000*num)
end
-------------------------------------------------------
