...
function ItemScriptObj:OnUseItem(objItemSys, objItem)
	...
	objPlayer:GetSystem('CFiveElemSystem'):FiveElementRecord(0, 0, 10000, 0, 0, _G.FiveElemSysOperType.ChgFiveByUseItem)
	--水
