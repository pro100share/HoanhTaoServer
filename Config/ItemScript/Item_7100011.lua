...
local dwNowTime = _now()
 ...
 local objPlayer = objItemSys:GetPlayer()
	...
	if dwMapId ~= 5085 then sysTask:Error(999911) return nil end;
	if math.sqrt((fPosX+0)^2+(fPosY-5)^2) > 5 then sysTask:Error(999911) return nil end; 
