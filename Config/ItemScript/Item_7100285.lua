...
local dwNowTime = _now()
	...
	if dwMapId ~= 5109 then sysTask:Error(999911) return nil end;
	if math.sqrt((fPosX-9)^2+(fPosY-15)^2) > 5 then sysTask:Error(999911) return nil end; 
