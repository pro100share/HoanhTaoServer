...
function ItemScriptObj:CheckForUse(objItemSys, objItem,sysScript)
	...
	if dwMapId ~= 5091 then sysTask:Error(999911) return nil end;
	if math.sqrt((fPosX+5)^2+(fPosY+2)^2) > 5 then sysTask:Error(999911) return nil end; 
