local dwItemId = 6300580    --华山论剑第三名
local ItemScriptObj = {};
...
local data = {
		...
		{4100430,1200,1};     ---檀心丹*1
		{2500331,800,1};     ---斩魄精元丹*1
		{4100507,1050,1};     ---灵兽丹*1
		{4100451,300,1};     ---风云名帖*1
		{3900050,500,1};     ---5品宝石精华*1
		{3900060,90,1};     ---6品宝石精华*1
		{2500343,600,1};     ---易筋经注*1
		{2500345,600,1};     ---紫微星图*1
		{2500051,450,1};     ---武尊通鉴*1
		{5501190,600,1};     ---无相元珠*1
