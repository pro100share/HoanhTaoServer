...
--【坐骑系统客户端文字显示配置】
_G.CMountClientConfig = {
	--坐骑空槽位
	EmptySlot		= _G.SysStringConfigInfo[7000160001];
	--坐骑等级字符串
	MountLevelStr	= _G.SysStringConfigInfo[7000160002];
	--激活按钮
	ActivateStr		= _G.SysStringConfigInfo[7000160003];
	--上马/下马按钮
	RideUpStr		= _G.SysStringConfigInfo[7000160004];
	RideDownStr		= _G.SysStringConfigInfo[7000160005];
	--没有坐骑
	NotAnyMount		= _G.SysStringConfigInfo[7000110001];
	--当前没有激活坐骑
	NotActiveMount	= _G.SysStringConfigInfo[7000110005];
	--等级不够无法激活
	LevelLow		= _G.SysStringConfigInfo[7000110002];
	--职业不符
	ErrorProf		= _G.SysStringConfigInfo[7000110006];
	--删除坐骑提示
	SureDeleteMount =  _G.SysStringConfigInfo[7000130001];
	--骑乘状态下申请打坐提示
	RideOnWantSit	= _G.SysStringConfigInfo[7000110007];
	--骑乘状态下申请双修提示
	RideOnWantShuangXiu	= _G.SysStringConfigInfo[7000110008];
	--移动状态申请上马
	MovingWantRideUp = _G.SysStringConfigInfo[7000110009];
	--打坐状态申请上马
	SitWantRideUp	= _G.SysStringConfigInfo[7000110004];
	--战斗状态申请上马
	FightWantRideUp	= _G.SysStringConfigInfo[7000110003];
	--死亡状态申请上马
	DeadWantRideUp	= _G.SysStringConfigInfo[7000110011];
	--坐骑获得经验
	MountAddExp		= _G.SysStringConfigInfo[7000120001];--"您的坐骑获得%d经验";
	--坐骑升级
	MountLevelUp	= _G.SysStringConfigInfo[7000120002];--"您的坐骑升到%d级";

	--坐骑满阶
	MountCanNotUpGrade = _G.SysStringConfigInfo[7000110014];
	--已满阶
	MountMaxGrade	= _G.SysStringConfigInfo[7000160048];
	--坐骑升阶成功率
	--UpGradeSucRateStr = "%d%%<font color='#00FF00'>（天官赐福+%d%%）</font>";
	--金钱不足
	NoMoney	= _G.SysStringConfigInfo[7000110015];
	--升阶神龙果不足
	NoSLG	= _G.SysStringConfigInfo[7000110016];
	--升阶进阶符不足
	NoJJF	= _G.SysStringConfigInfo[7000110017];
	--自动购买背包空间不足
	AutoBuyNoRoom	= _G.SysStringConfigInfo[7000110018];
	--自动购买元宝不足
	AutoBuyNoMoney	= _G.SysStringConfigInfo[7000110019];
	--坐骑使用绑定材料
	MountBindNotice =  _G.SysStringConfigInfo[7000130002];
	--升阶成功提示
	UpGradeSuccess	=  _G.SysStringConfigInfo[7000120007];
	--升阶失败提示
	UpGradeFailed	=  _G.SysStringConfigInfo[7000120008];

	--坐骑品质满
	MountCanNotUpQuality = _G.SysStringConfigInfo[7000110021];
	--品质已满
	MountMaxQuality = _G.SysStringConfigInfo[7000160042];
	--提升品质、资质成功率提示文本
	MountUpQualitySucStr1 = _G.SysStringConfigInfo[7000160043];
	MountUpQualitySucStr2 = _G.SysStringConfigInfo[7000160044];
	MountUpAptitudeSucStr2 = _G.SysStringConfigInfo[7000160045];
	--资质已达上限
	MountMaxAptitude1 = _G.SysStringConfigInfo[7000160046];
	MountMaxAptitude2 = _G.SysStringConfigInfo[7000160047];
	--提升资质果不足
	NoZZG		= _G.SysStringConfigInfo[7000110024];
	--提升幸运珠不足
	NoXYZ		= _G.SysStringConfigInfo[7000110025];
	--攻击资质已满
	MountCanNotUpGJAptitude	= _G.SysStringConfigInfo[7000110026];
	--防御资质已满
	MountCanNotUpFYAptitude	= _G.SysStringConfigInfo[7000110027];
	--根骨资质已满
	MountCanNotUpGGAptitude	= _G.SysStringConfigInfo[7000110028];
	--技巧资质已满
	MountCanNotUpJQAptitude	= _G.SysStringConfigInfo[7000110029];
	--提升品质成功提示
	UpQualitySuccess = _G.SysStringConfigInfo[7000120009];
	--提升品质失败提示--提升资质失败提示
	UpQualityFailed = _G.SysStringConfigInfo[7000110030];
	--提升资质成功提示
	UpAptitudeSuccess = _G.SysStringConfigInfo[7000120010];
	--四项资质文字
	GongJiAptitude = _G.SysStringConfigInfo[7000160006];
	FangYuAptitude = _G.SysStringConfigInfo[7000160007];
	GenGuAptitude = _G.SysStringConfigInfo[7000160008];
	JiQiaoAptitude = _G.SysStringConfigInfo[7000160009];
	--广播
	BroadCastUpGrade = _G.SysStringConfigInfo[7000140001];
	BroadCastUpQuality =_G.SysStringConfigInfo[7000170001];
	IWantTry		= _G.SysStringConfigInfo[7000170002];
	BroadCastError	= _G.SysStringConfigInfo[7000110043];
	PlayerNotOnLine = _G.SysStringConfigInfo[7000110044];
	CannotViewSelf = _G.SysStringConfigInfo[7000110045];

	--获得坐骑提示
	AddNewMount		= _G.SysStringConfigInfo[7000120003];--"您获得了坐骑%s";
	--删除坐骑提示
	DeleteMount		= _G.SysStringConfigInfo[7000120004];--"您失去了坐骑%s";

	--骑乘
	RideStr 	= _G.SysStringConfigInfo[7000150015];
	--激活
	ActivateRollOver = _G.SysStringConfigInfo[7000150001];
	--培养
	TrainStr	= _G.SysStringConfigInfo[7000150002];
	--遣散
	DelStr		= _G.SysStringConfigInfo[7000150003];
	--展示
	ShowStr		= _G.SysStringConfigInfo[7000150009];
	--坐骑经验鼠标进入提示
	MountExpStr		= _G.SysStringConfigInfo[7000150004];
	--坐骑攻击资质鼠标进入提示
	MountGJApStr	= _G.SysStringConfigInfo[7000150010];
	--坐骑防御资质鼠标进入提示
	MountFYApStr	= _G.SysStringConfigInfo[7000150011];
	--坐骑根骨资质鼠标进入提示
	MountGGApStr	= _G.SysStringConfigInfo[7000150012];
	--坐骑技巧资质鼠标进入提示
	MountJQApStr	= _G.SysStringConfigInfo[7000150013];

	GongJiStr	= _G.SysStringConfigInfo[7000160010];
	GongJiStr1	= _G.SysStringConfigInfo[7000160011];
	GongJiStr2	= _G.SysStringConfigInfo[7000160012];
	GongJiMaxStr = _G.SysStringConfigInfo[7000160013];
	GongJiMaxStr1 = _G.SysStringConfigInfo[7000160014];
	GongJiMaxStr2 = _G.SysStringConfigInfo[7000160015];
	GongJiScript = _G.SysStringConfigInfo[7000160016];

	FangYuStr	= _G.SysStringConfigInfo[7000160017];
	FangYuStr1	= _G.SysStringConfigInfo[7000160018];
	FangYuStr2	= _G.SysStringConfigInfo[7000160019];
	FangYuMaxStr = _G.SysStringConfigInfo[7000160020];
	FangYuMaxStr1 = _G.SysStringConfigInfo[7000160021];
	FangYuMaxStr2 = _G.SysStringConfigInfo[7000160022];
	FangYuScript = _G.SysStringConfigInfo[7000160023];

	GenGuStr	= _G.SysStringConfigInfo[7000160024];
	GenGuStr1	= _G.SysStringConfigInfo[7000160025];
	GenGuStr2	= _G.SysStringConfigInfo[7000160026];
	GenGuStr3	= _G.SysStringConfigInfo[7000160027];
	GenGuMaxStr = _G.SysStringConfigInfo[7000160028];
	GenGuMaxStr1 = _G.SysStringConfigInfo[7000160029];
	GenGuMaxStr2 = _G.SysStringConfigInfo[7000160030];
	GenGuMaxStr3 = _G.SysStringConfigInfo[7000160031];
	GenGuScript = _G.SysStringConfigInfo[7000160032];

	JiQiaoStr 	= _G.SysStringConfigInfo[7000160033];
	JiQiaoStr1 	= _G.SysStringConfigInfo[7000160034];
	JiQiaoStr2 	= _G.SysStringConfigInfo[7000160035];
	JiQiaoStr3 	= _G.SysStringConfigInfo[7000160036];
	JiQiaoMaxStr = _G.SysStringConfigInfo[7000160037];
	JiQiaoMaxStr1 = _G.SysStringConfigInfo[7000160038];
	JiQiaoMaxStr2 = _G.SysStringConfigInfo[7000160039];
	JiQiaoMaxStr3 = _G.SysStringConfigInfo[7000160040];
	JiQiaoScript = _G.SysStringConfigInfo[7000160041];

	NoLearnSkill 	= _G.SysStringConfigInfo[7000160049];
	SkillLevelMax	= _G.SysStringConfigInfo[7000160050];
	MountNotLearnSkill = _G.SysStringConfigInfo[7000110034];
	MountSkillLevelMax = _G.SysStringConfigInfo[7000110035];
	MountLevelLow_Skill		= _G.SysStringConfigInfo[7000110036];
	FiveElemNotEnough	= _G.SysStringConfigInfo[7000110037];
	UpSkillSuccess =  _G.SysStringConfigInfo[7000120005];
	UpSkillFailed =   _G.SysStringConfigInfo[7000120006];

	CannotPutHere = _G.SysStringConfigInfo[7000110038];
	MountLevelLow = _G.SysStringConfigInfo[7000110039];

	MountHaveEquip = _G.SysStringConfigInfo[7000110040];
	SlotLocked = _G.SysStringConfigInfo[7000110041];

	Equip_1_RollOver = _G.SysStringConfigInfo[7000150005];
	Equip_2_RollOver = _G.SysStringConfigInfo[7000150006];
	Equip_3_RollOver = _G.SysStringConfigInfo[7000150007];
	Equip_4_RollOver = _G.SysStringConfigInfo[7000150008];

	MaxGradeValue = _G.SysStringConfigInfo[7000160051];
	UpGradeAddValue = _G.SysStringConfigInfo[7000160052];
	UpGradeDelValue = _G.SysStringConfigInfo[7000160053];
	UpGradeNoChange = _G.SysStringConfigInfo[7000160054];

	MountUpQualityStr	= _G.SysStringConfigInfo[7000160055];
	MountUpGJApStr		= _G.SysStringConfigInfo[7000160056];
	MountUpFYApStr		= _G.SysStringConfigInfo[7000160057];
	MountUpGGApStr		= _G.SysStringConfigInfo[7000160058];
	MountUpJQApStr		= _G.SysStringConfigInfo[7000160059];

	MountUpGradeDownLevel = _G.SysStringConfigInfo[7000160060] ;

	MaxQualityValue = _G.SysStringConfigInfo[7000160061];
	UpQualityAddValue = _G.SysStringConfigInfo[7000160062];
};
--【坐骑资质配置】
...
_G.CMountSystemConfig = {
	...
	AutoRunRideLen = 25;
	--获得坐骑通知图标
	GetNewMountNoticeIcon = _G.NoticeIconConfig[15];
	--坐骑技能可以升级通知图标
	ActiveMountSkillCanLevelUp = _G.NoticeIconConfig[24];
	--上马特效
	RideOnEffectID = 8;
	--下马特效
	RideDownEffectID = 9;
...
_G.CMountSixBasePropConfig = {
	...
	[121]={n_Level=121,n_ShengMing=1486,n_NeiLi=323,n_GongJi=395,n_FangYu=204,n_BaoJi=192,n_ShenFa=251,},	
};
--【坐骑升级经验】
