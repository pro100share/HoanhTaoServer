...
function MonsterScript:CBMonsterOnBorn(Monster)
	...
	local Pos = Monster:GetVectorPos()		---获得怪物坐标
		...
		if (Pos.x+38.68)^2+(Pos.y-49.11)^2 < 2^2 then	---是否某个距离之内
			local yidong = 
			{
				{x=-38.85,y=40.99,dwSpeed=5};
				{x=-37.24,y=-28.52,dwSpeed=5};
				{x=-30.01,y=-35.86,dwSpeed=5};
				{x=-12.71,y=-38.09,dwSpeed=5};
				{x=-15.32,y=30.43,dwSpeed=5};
				{x=0.87,y=42.95,dwSpeed=5};
				{x=20.95,y=32.39,dwSpeed=5};
				{x=34.55,y=-26.45,dwSpeed=5};
			}
		...
		if (Pos.x+43.15)^2+(Pos.y-49.93)^2 < 2^2 then	---是否某个距离之内
			local yidong = 
			{
				{x=-42.37,y=41.76,dwSpeed=5};
				{x=-40.43,y=-30.82,dwSpeed=5};
				{x=-30.73,y=-39.36,dwSpeed=5};
				{x=-9.09,y=-40.55,dwSpeed=5};
				{x=-10.27,y=27.10,dwSpeed=5};
				{x=-0.30,y=37.89,dwSpeed=5};
				{x=16.65,y=29.87,dwSpeed=5};
				{x=29.99,y=-27.97,dwSpeed=5};
			}
			Monster:MoveTo(yidong,true)
		end
