...
function MonsterScript:CBMonsterOnDead(Monster,objKiller)
			--[[		
	if type(objKiller.LXY1001)~="number" then
		...
		if Task and Task:GetTaskState()==4 then
			...
			CGameLineManager:AddMonster(1001,10011008,19,-73,0, szName, szTitle,dwObjId,objKiller)
			objKiller.LXY1001 = 1234;
		end
	end
			--]]	
end		
