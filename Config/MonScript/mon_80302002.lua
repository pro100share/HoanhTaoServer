...
function MonsterScript:CBMonsterOnBorn(Monster)
	...
	sysMonsterBuff:AddBuff(9506,2,Monster)
end
--死亡时执行
function MonsterScript:CBMonsterOnDead(Monster,Enemy)
	...
	CScriptManager:Notice(string.format(SysStringConfigInfo[13009000003],Name,"%s"),6,false,8030,15,52,SysStringConfigInfo[71])
