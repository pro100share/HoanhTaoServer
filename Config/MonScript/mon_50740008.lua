local dwMonsterId = 50740008	--BOSS
local MonsterScript = {}
...
function MonsterScript:CBMonsterOnUpdate(Monster)
	...
	if tmNow - Monster.xiaozhu >= 40000 then
		...
		-- if(Monster.tt == 0) then
			...
			mgrMonster:DelayAdd(50740009,DuplAddition[1017]:GetFightIDToPig(Map),50740009,10092003,50740009,Pos.x,Pos.y,dwObjId,10)
			Monster:Remove()
			-- tt = 1
		-- end
	end
	...
	if ((Pos.x-9.90)^2+(Pos.y+16.31)^2 < 9) or ((Pos.x+7.17)^2+(Pos.y-6.47)^2 < 9) then
		...
		-- print( "111111111111==============11111111111111=======0808" )
		...
		-- print( "2222222222222==============222222222222222=======0808" )
				local dwAllLevel = 0						
				local dwPlayerNum = 0
				for _,objPlayer in pairs(Players) do
				...
				-- print( "333333333333333==============3333333333333=======0808" )
				...
				-- print( "444444444444==============4444444444444444=======0808" )
		...
		-- print( "555555555555555==============55555555555555=======0808" )
		end
