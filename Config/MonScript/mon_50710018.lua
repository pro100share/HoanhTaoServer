local dwMonsterId = 50710018	--BOSS
local MonsterScript = {}
------
--[[
--]]
...
function MonsterScript:CBMonsterBeforeBorn(Monster)
	MonsterDecision:AllPropertyBoost(Monster,0.5)
end
--死亡时执行
function MonsterScript:CBMonsterOnDead(Monster,objPlayer,sysScript)
		...
		-- mgrMonster:DelayAdd(50710019,(3000+dwLevelm+2),50710002,(102000+(math.floor(dwLevelm/5)*5)),3.3,2.47,dwObjId,20000)
end
----------------------------------------------------------------------------
