local dwMonsterId = 50720007	--BOSS
local MonsterScript = {}
------
--[[
--]]
...
function MonsterScript:CBMonsterOnUpdate(Monster)
	...
	if (Pos.x+2.31)^2+(Pos.y+2.49)^2 < 1^2 then
		...
		Map.xiayibo07 = (Map.xiayibo07 or 0) + 1
		...
		if  Map.xiayibo07 == 180 then
				
			local D1 = function()
						Monster:MapNotice(9000660566,7)
						for sg = 1,60 do  ----刷第六波怪1  金
							mgrMonster:DelayAdd(50720008,(1000+dwLevelm+1),50720001,50720001,100320030,-61.85,67.30,dwObjId,(sg*1500))
						end
						for sg = 1,60 do  ----刷第六波怪2 南疆
							mgrMonster:DelayAdd(50720008,(1000+dwLevelm+1),50720001,50720001,100620010,-68.14,-63.61,dwObjId,(sg*1500))
						end
						for sg = 1,60 do  ----刷第六波怪3  波斯
							mgrMonster:DelayAdd(50720008,(1000+dwLevelm+1),50720001,50720001,101020060,73.90,-80.36,dwObjId,(sg*1500))
						end	
						for sg = 1,60 do  ----刷第六波怪4 蒙古
							mgrMonster:DelayAdd(50720008,(1000+dwLevelm+1),50720001,50720001,101120020,72.66,55.16,dwObjId,(sg*1500))
						end	
						mgrMonster:DelayAdd(50720018,(3000+dwLevelm+5),50720011,(102000+(math.floor(dwLevelm/5)*5)),100720030,-61.85,67.30,dwObjId,90000)--出BOSS
						mgrMonster:DelayAdd(50720018,(3000+dwLevelm+5),50720011,(102000+(math.floor(dwLevelm/5)*5)),100620060,-68.14,-63.61,dwObjId,90000)--出BOSS
						mgrMonster:DelayAdd(50720018,(3000+dwLevelm+5),50720011,(102000+(math.floor(dwLevelm/5)*5)),101120060,73.90,-80.36,dwObjId,90000)--出BOSS
						mgrMonster:DelayAdd(50720018,(3000+dwLevelm+5),50720011,(102000+(math.floor(dwLevelm/5)*5)),100820050,72.66,55.16,dwObjId,90000)--出BOSS
			end	
