local dwMonsterId = 50702006  -------本波12辆车
local MonsterScript = {}
------
--[[
--]]
...
function MonsterScript:CBMonsterOnUpdate(Monster)
	...
	local dwLevelm = Monster:GetLevel()        ----获得怪物等级
		...
		if (Pos.x-32.62)^2+(Pos.y+29.02)^2 < 2^2 then
			Monster:Remove()
			...
			if Map.lrxxx>9 then
				local Monster01 = mgrMonster:GetMonsterById(50702006)
				if #Monster01<1 then
					Map.lrxxx = 0	---地图计数器清0
					Map.shijian = 0		---特殊事件计数器清0
					Map.shijian02 = 0	---特殊事件02计数器清0 ----用来防止第1个触发点多次触发
					Map.shijian03 = 0	---特殊事件03计数器清0 ----用来防止第2个触发点多次触发
					Monster:SetDuplData(7)
					Monster:MapNotice(9000660284,7)
					local C1 = function()
					mgrMonster:Add(50702007,(1000+dwLevelm+1),50702007,50702001,80010,-40.75,49.73)
					...
					mgrMonster:DelayAdd(50702007,(1000+dwLevelm+1),50702007,50702001,80010,-40.75,49.73,dwObjId,10500)
					...
					mgrMonster:DelayAdd(50702007,(1000+dwLevelm+1),50702007,50702001,80010,-40.75,49.73,dwObjId,21000)
					...
					mgrMonster:DelayAdd(50702007,(1000+dwLevelm+1),50702007,50702003,80020,-40.75,49.73,dwObjId,31500)
					...
					mgrMonster:DelayAdd(50702007,(1000+dwLevelm+1),50702007,50702003,80020,-40.75,49.73,dwObjId,42000)
					...
					mgrMonster:DelayAdd(50702007,(1000+dwLevelm+1),50702007,50702003,80020,-40.75,49.73,dwObjId,52500)
					...
					mgrMonster:DelayAdd(50702007,(1000+dwLevelm+1),50702007,50702003,80020,-40.75,49.73,dwObjId,63000)
					mgrMonster:DelayAdd(50702012,(2000+dwLevelm+1),50702012,(21000+(math.floor((dwLevelm+1)/5)*5)),100920020,-43.15,49.93,dwObjId,63000)
					mgrMonster:DelayAdd(50702011,(2000+dwLevelm+1),50702011,(21000+(math.floor((dwLevelm+1)/5)*5)),100320050,-38.68,49.11,dwObjId,67500)

					mgrMonster:DelayAdd(50702007,(1000+dwLevelm+1),50702007,50702004,80030,-40.75,49.73,dwObjId,73500)
					mgrMonster:DelayAdd(50702011,(2000+dwLevelm+1),50702011,(21000+(math.floor((dwLevelm+1)/5)*5)),100320050,-38.68,49.11,dwObjId,73500)
					mgrMonster:DelayAdd(50702012,(2000+dwLevelm+1),50702012,(21000+(math.floor((dwLevelm+1)/5)*5)),100920020,-43.15,49.93,dwObjId,78000)

					mgrMonster:DelayAdd(50702007,(1000+dwLevelm+1),50702007,50702004,80030,-40.75,49.73,dwObjId,84000)
					mgrMonster:DelayAdd(50702011,(2000+dwLevelm+1),50702011,(21000+(math.floor((dwLevelm+1)/5)*5)),100320050,-38.68,49.11,dwObjId,84000)
					mgrMonster:DelayAdd(50702012,(2000+dwLevelm+1),50702012,(21000+(math.floor((dwLevelm+1)/5)*5)),100920020,-43.15,49.93,dwObjId,88500)
					
					mgrMonster:DelayAdd(50702007,(1000+dwLevelm+1),50702007,50702004,80030,-40.75,49.73,dwObjId,94500)
					mgrMonster:DelayAdd(50702011,(2000+dwLevelm+1),50702011,(21000+(math.floor((dwLevelm+1)/5)*5)),100320050,-38.68,49.11,dwObjId,94500)
					mgrMonster:DelayAdd(50702012,(2000+dwLevelm+1),50702012,(21000+(math.floor((dwLevelm+1)/5)*5)),100920020,-43.15,49.93,dwObjId,99000)
					
					mgrMonster:DelayAdd(50702007,(1000+dwLevelm+1),50702007,50702004,80030,-40.75,49.73,dwObjId,105000)
					mgrMonster:DelayAdd(50702011,(2000+dwLevelm+1),50702011,(21000+(math.floor((dwLevelm+1)/5)*5)),100320050,-38.68,49.11,dwObjId,105000)
					mgrMonster:DelayAdd(50702012,(2000+dwLevelm+1),50702012,(21000+(math.floor((dwLevelm+1)/5)*5)),100920020,-43.15,49.93,dwObjId,109500)
					
					mgrMonster:DelayAdd(50702007,(1000+dwLevelm+1),50702007,50702004,80030,-40.75,49.73,dwObjId,115500)
					mgrMonster:DelayAdd(50702011,(2000+dwLevelm+1),50702011,(21000+(math.floor((dwLevelm+1)/5)*5)),100320050,-38.68,49.11,dwObjId,115500)
					mgrMonster:DelayAdd(50702012,(2000+dwLevelm+1),50702012,(21000+(math.floor((dwLevelm+1)/5)*5)),100920020,-43.15,49.93,dwObjId,120000)
					end
...
--------------------到达第1个事件触发点，进行逻辑
		if (Pos.x+40.75)^2+(Pos.y-49.73)^2 < 2^2 then ---是否某个距离内
			...
			if Map.shijian < 1 and Map.shijian02 < 2 then	---检测第1个地点是否需要触发事件，以及控制是否多次踩点触发这个事件
				...
				-----25%概率 刷小猪
				elseif (dwRand > 1500 and dwRand < 2000) then
					Map.shijian = (Map.shijian or 0) + 1	---事件计数器+1
...
function MonsterScript:CBMonsterOnDead(Monster,objPlayer,sysScript)
	...
	--if Map.lrxxx>8 then
		local Monster01 = mgrMonster:GetMonsterById(50702006)
		if #Monster01<1 and  Map.lrxxx>9 then
					Map.lrxxx = 0	---地图计数器清0
					Map.shijian = 0		---特殊事件计数器清0
					Map.shijian02 = 0	---特殊事件02计数器清0 ----用来防止第1个触发点多次触发
					Map.shijian03 = 0	---特殊事件03计数器清0 ----用来防止第2个触发点多次触发
