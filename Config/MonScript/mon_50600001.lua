...
function MonsterScript:CBMonsterOnDead(Monster,objPlayer,sysScript)
	...
	if n==35 then
		...
		Monster:MapNotice(9000660802,7)
		--DuplAddition[1007]:AddBuffOrMesForArmy( 2,objPlayer,9000660802,9000660802,50600001,1,7 )
		n = 0
	end 
	...
	objMap.qjCount[50600001] = (objMap.qjCount[50600001] or 0) + 1
	...
	if (objMap.qjCount[50600001] == 35) then
		local BoShu = 2;
