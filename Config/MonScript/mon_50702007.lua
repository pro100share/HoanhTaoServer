...
function MonsterScript:CBMonsterOnUpdate(Monster)
	...
	local dwLevelm = Monster:GetLevel()        ----获得怪物等级
		...
		if (Pos.x-32.62)^2+(Pos.y+29.02)^2 < 2^2 then
			...
			if Map.lrxxx>11 then
				local Monster01 = mgrMonster:GetMonsterById(50702007)
				if #Monster01<1 then
					Map.lrxxx = 0	---地图计数器清0
					...
					local C1 = function()
					Monster:MapNotice(9000660292,7)
					mgrMonster:Add(50702020,(3000+dwLevelm),50702020,50702020,100820050,-40.75,49.73)
					mgrMonster:Add(50702024,(2000+dwLevelm+1),50702024,(21000+(math.floor((dwLevelm+1)/5)*5)),100920040,-38.68,49.11)
					mgrMonster:Add(50702024,(2000+dwLevelm+1),50702024,(21000+(math.floor((dwLevelm+1)/5)*5)),100920040,-43.15,49.93)
					mgrMonster:DelayAdd(50702024,(2000+dwLevelm+1),50702024,(21000+(math.floor((dwLevelm+1)/5)*5)),100920040,-38.68,49.11,dwObjId,1000)
					mgrMonster:DelayAdd(50702024,(2000+dwLevelm+1),50702024,(21000+(math.floor((dwLevelm+1)/5)*5)),100920040,-43.15,49.93,dwObjId,1000)
					mgrMonster:DelayAdd(50702024,(2000+dwLevelm+1),50702024,(21000+(math.floor((dwLevelm+1)/5)*5)),100920040,-38.68,49.11,dwObjId,2000)
					mgrMonster:DelayAdd(50702024,(2000+dwLevelm+1),50702024,(21000+(math.floor((dwLevelm+1)/5)*5)),100920040,-43.15,49.93,dwObjId,2000)
					mgrMonster:DelayAdd(50702024,(2000+dwLevelm+1),50702024,(21000+(math.floor((dwLevelm+1)/5)*5)),100920040,-38.68,49.11,dwObjId,3000)
					mgrMonster:DelayAdd(50702024,(2000+dwLevelm+1),50702024,(21000+(math.floor((dwLevelm+1)/5)*5)),100920040,-43.15,49.93,dwObjId,3000)
					mgrMonster:DelayAdd(50702024,(2000+dwLevelm+1),50702024,(21000+(math.floor((dwLevelm+1)/5)*5)),100920040,-38.68,49.11,dwObjId,4000)
					mgrMonster:DelayAdd(50702024,(2000+dwLevelm+1),50702024,(21000+(math.floor((dwLevelm+1)/5)*5)),100920040,-43.15,49.93,dwObjId,4000)
					mgrMonster:DelayAdd(50702024,(2000+dwLevelm+1),50702024,(21000+(math.floor((dwLevelm+1)/5)*5)),100920040,-38.68,49.11,dwObjId,5000)
					mgrMonster:DelayAdd(50702024,(2000+dwLevelm+1),50702024,(21000+(math.floor((dwLevelm+1)/5)*5)),100920040,-43.15,49.93,dwObjId,5000)
					end
...
function MonsterScript:CBMonsterOnDead(Monster,objPlayer,sysScript)
	...
	--if Map.lrxxx>11 then
		local Monster01 = mgrMonster:GetMonsterById(50702007)
		if #Monster01<1 and  Map.lrxxx>11 then
					Map.lrxxx = 0	---地图计数器清0
					Map.shijian = 0		---特殊事件计数器清0
					Map.shijian02 = 0	---特殊事件02计数器清0 ----用来防止第1个触发点多次触发
					Map.shijian03 = 0	---特殊事件03计数器清0 ----用来防止第2个触发点多次触发
					Monster:SetDuplData(8)
					local C1 = function()
					sysScript:TeamNotice(9000660292,7)
					mgrMonster:Add(50702020,(3000+dwLevelm),50702020,50702020,100820050,-40.75,49.73)
					mgrMonster:Add(50702024,(2000+dwLevelm+1),50702024,(21000+(math.floor((dwLevelm+1)/5)*5)),100920040,-38.68,49.11)
					mgrMonster:Add(50702024,(2000+dwLevelm+1),50702024,(21000+(math.floor((dwLevelm+1)/5)*5)),100920040,-43.15,49.93)
					mgrMonster:DelayAdd(50702024,(2000+dwLevelm+1),50702024,(21000+(math.floor((dwLevelm+1)/5)*5)),100920040,-38.68,49.11,dwObjId,1000)
