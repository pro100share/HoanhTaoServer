...
function MonsterScript:CBMonsterOnDead(Monster,objPlayer,sysScript)
	n = n+1
	if n==35 then
		Monster:SetDuplData(14)
		Monster:MapNotice(9000660814,7)		
		n = 0
	end 
	
	local objMap = Monster.Map
	objMap.qjCount = objMap.qjCount or {}
	objMap.qjCount[50600013] = (objMap.qjCount[50600013] or 0) + 1
	...
	if (objMap.qjCount[50600013] == 35) then
		local BoShu = 14;
