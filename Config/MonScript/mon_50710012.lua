local dwMonsterId = 50710012	--BOSS
local MonsterScript = {}
------
--[[
--]]
...
function MonsterScript:CBMonsterBeforeBorn(Monster)
	MonsterDecision:AllPropertyBoost(Monster,0.1)
end
--死亡时执行
function MonsterScript:CBMonsterOnDead(Monster,objPlayer,sysScript)
		...
		mgrMonster:DelayAdd(50710013,(3000+dwLevelm+2),50710002,(102000+(math.floor((dwLevelm+2)/5)*5)),507100151,3.3,2.47,dwObjId,20000)
end
----------------------------------------------------------------------------
