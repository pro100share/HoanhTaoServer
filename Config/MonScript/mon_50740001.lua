local dwMonsterId = 50740001	--BOSS
local MonsterScript = {}
-- local tt = 0
------
--[[
...
function MonsterScript:CBMonsterOnUpdate(Monster)
	...
	if tmNow - Monster.xiaozhu >= 40000 then
			...
			mgrMonster:DelayAdd(50740002,50502010,50740002,10092003,50740002,Pos.x,Pos.y,dwObjId,10)
			Monster:Remove()
	end
	...
	if ((Pos.x-9.90)^2+(Pos.y+16.31)^2 < 9) or ((Pos.x+7.17)^2+(Pos.y-6.47)^2 < 9) then
		...
		if tmNow - Monster.zhujuan >= 5000 then
				...
				if DuplAddition[1017].Mark >= 10 then		--如果标记为5	
					...
					if (#Monster==0) and (#Monster1==0) and (#Monster2==0) and (#Monster3==0) and (#Monster4==0) 
						and (#Monster5==0) and (#Monster6==0) and (#Monster7==0) then	
