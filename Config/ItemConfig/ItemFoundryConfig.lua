...
_G.ItemFoundryConfig = {
		...
		Value ={
				...
				[31] 	= {Num=180,dwflag = 1,AddShX=7,	SuccessRate =10000 };				--Num消耗物品数量，AddShX成功后加成的属性百分比
				[32] 	= {Num=180,dwflag = 1,AddShX=7,	SuccessRate =10000 };
				[33] 	= {Num=180,dwflag = 1,AddShX=7,	SuccessRate =10000 };
				[34] 	= {Num=180,dwflag = 1,AddShX=7,	SuccessRate =10000 };
				[35]	= {Num=180,dwflag = 1,AddShX=7,	SuccessRate =10000 };
			};
