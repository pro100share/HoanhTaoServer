...
_G.ItemUIByEnum = 
{
	...
	[5807006] = function(objItem) CChestSystem:ShowChestWnd(objItem:GetInstID()) end;	 ---打开宝箱界面	
	[5807007] = function(objItem) CChestSystem:ShowChestWnd(objItem:GetInstID()) end;	 ---打开宝箱界面	
...
_G.ItemUIByPCType = 
{
	...
	[50050] = function(objItem)
		return HeroTokenUI:TryOpenUI(objItem:GetEnumID());
	end;
}
--物品大类的索引
_G.ItemUIByPType = 
...
_G.HolderExtendConfig = 
{
	...
	[enItemPosition.ePacket] = 
	{
		strFirst = "%s激活背包需要在背包中有%d个%s</font>";
		strSecond = "1.击杀野外BOSS获得<br/>2.参与线上活动获得<br/>3.商城购买获得";
		strThird = "请问您是要激活背包吗？";
		
	};
	[enItemPosition.eStorage] = 
	{
		strFirst = "%s激活需要背包中有%d个%s</font>";
		strSecond = "1.击杀野外BOSS获得<br/>2.参与线上活动获得<br/>3.商城购买获得";
		strThird = "请问您是要激活仓库吗？";
