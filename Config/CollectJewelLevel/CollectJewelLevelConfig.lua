...
_G.CollectJewelLevelTipsConfig = {
	szNotGrains = "大侠您还未到达领取礼包所需等级";
	szGainsItem = "大侠奖励已发送",
	szEmailSuc = "奖励物品已发送至邮箱，请验收",
	szNotOPen = "大侠请先启灵灵珠，才可领取奖励",
	szOpenCollcet = "大侠只需花费%d元宝即可获得%d元宝等级礼包，是否花费%d元宝启灵聚灵珠",
	szNotCanGrains = "大侠您还差%d级领取超值大礼";
	szOpenTips = "大侠是否花费%d元宝启灵聚灵珠",
	szNotGlod = "大侠您的元宝不足",
	szHadGet = "大侠您已领取该奖励", -->点击领取奖励按钮时提示
	szGetTips = "大侠请点击下方领取按钮领取奖励", 
	szNextGet = "大侠当前等级已领取，请领取下一级奖励",
};