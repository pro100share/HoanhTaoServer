...
_G.GoldenBodyConfig = {
	...
	BlessList = {
		[1] = {nId = 4100512, nNum = 2, nRate = 0.5, tRange = {nFloor = 30, nCeil = 80}, name ="铜皮石肤",rank = "极高",},
		[2] = {nId = 4100512, nNum = 3, nRate = 0.3, tRange = {nFloor = 120, nCeil = 210}, name ="钢筋铁骨",rank = "高",},
		[3] = {nId = 4100512, nNum = 5, nRate = 0.25, tRange = {nFloor = 300, nCeil = 550}, name ="玉质金相",rank = "一般",},
		[4] = {nId = 4100512, nNum = 7, nRate = 0.15, tRange = {nFloor = 800, nCeil = 1500}, name ="循经贯脉",rank = "低",},
		[5] = {nId = 4100512, nNum = 10, nRate = 0.1, tRange = {nFloor = 2000, nCeil = 3000}, name ="刀枪不入",rank = "极低",},
		[6] = {nId = 4100512, nNum = 15, nRate = 0.05, tRange = {nFloor = 4000, nCeil = 5000}, name ="坚不可摧",rank = "极低",},
		[7] = {nId = 4100512, nNum = 20, nRate = 0.03, tRange = {nFloor = 6500, nCeil = 8000}, name ="稳如泰山",rank = "极低",},
		[8] = {nId = 4100512, nNum = 25, nRate = 0.02, tRange = {nFloor = 9000, nCeil = 12500}, name ="金身不破",rank = "极低",},
		[9] = {nId = 4100512, nNum = 30, nRate = 0.01, tRange = {nFloor = 12000, nCeil = 15000}, name ="宝体通神",rank = "极低",},
		[10] = {nId = 4100512, nNum = 35, nRate = 0.01, tRange = {nFloor = 25000, nCeil = 30000}, name ="万劫不磨",rank = "极低",},
		 },

	BoardcastLevel = {9,18,27,36,45,54,63,72,81,90},
	JumpLevel = {10,19,28,37,46,55,64,73,82},
    ------------------------------------以上数值类的配置信息均可由公用函数获取-------------------------------------------
	...
	pearlname = {[1] ="引气",[2] = "筑基",[3] = "金丹", [4] = "元婴", [5] = "炼神", [6]= "返虚", [7] ="合道",[8] = "渡劫",[9] = "大乘" },
	IsEnough = "<font color='#31cf32'>%s</font>";--材料符合
	IsNoEnough = "<font color='#FF0000'>%s</font>";	--材料不符
	IntorduceText = "1、修炼消耗修炼值、经验和银两<br/>2、可以服用“修炼丹”、“不灭金丹”快速恢复修炼值<br/>3、修炼丹在卧虎藏龙副本和通天塔中掉落<br/>4、修炼值达到上限后不会再增加";--介绍
	...
	BroadString3 = "恭喜%s大侠成功把金身之%s境界修炼圆满，请再接再厉！我也试试";	
	BroadString2 = "恭喜%s大侠成功把金身之%s境界修炼圆满，请再接再厉！我也试试";
	BroadString1 = "恭喜%s大侠成功把金身之%s境界修炼圆满，请再接再厉！";
	Image = "img://gn_ZhanQiJue_jingjie.png";
	sLabel9 = "成功率：%s";
	sText  = "修炼值：<font size='13' color='#31cf32'>每10分钟恢复1点修炼值</font>";
	Zidong = "自动突破";
	Quxiao = " 取消自动";
	CifuText = "赐福 + "
}
